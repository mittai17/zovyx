...
metadata: { "zuvix": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Zuvix CLI path: `node --inspect-brk zuvix.mjs ...`
- Zuvix test path: `ZUVIX_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
