---
name: healthcheck
description: "Audit/harden Zuvix hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Zuvix host healthcheck
...
- Never claim Zuvix manages OS firewall, SSH, or updates.
...
- Zuvix gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `zuvix security audit --deep`.
