...
import ai.zuvix.app.NotificationBurstLimiter
import ai.zuvix.app.SecurePrefs
import ai.zuvix.app.allowsPackage
import ai.zuvix.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("zuvix.secure", Context.MODE_PRIVATE)
