      ...
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            ...
            CommandBlock("zuvix devices list")
            CommandBlock("zuvix devices approve <requestId>")
          }
          Text("Zuvix Android ${zuvixAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("zuvix qr --setup-code-only")
          CommandBlock("zuvix qr --json")
          Text(
...
private fun gatewayPairingInstruction(problem: GatewayConnectionProblem?): String =
  if (problem?.canAutoRetry == true) {
    "Approve this phone on the gateway. Zuvix will reconnect automatically."
  } else {
