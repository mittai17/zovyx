...
import ai.zuvix.app.ui.mobileAccentBorderStrong
...
import ai.zuvix.app.ui.mobileHeadline
import ai.zuvix.app.ui.mobileSurface
import ai.zuvix.app.ui.mobileText
import ai.zuvix.app.ui.mobileTextSecondary
import ai.zuvix.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.zuvix.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.zuvix.app.ui.mobileFontFamily,
