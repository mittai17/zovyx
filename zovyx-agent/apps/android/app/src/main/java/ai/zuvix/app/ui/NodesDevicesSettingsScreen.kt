...
import ai.zuvix.app.GatewayDeviceTokenSummary
import ai.zuvix.app.GatewayNodeSummary
import ai.zuvix.app.GatewayNodesDevicesSummary
import ai.zuvix.app.GatewayPairedDeviceSummary
import ai.zuvix.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "Zuvix $it" }
