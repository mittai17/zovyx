...
private val LocalZuvixDarkTheme = staticCompositionLocalOf { true }
...
fun ZuvixTheme(
  ...
  ZuvixSystemBarAppearance(lightAppearance = !isDark)

  CompositionLocalProvider(
    LocalMobileColors provides mobileColors,
    LocalZuvixDarkTheme provides isDark,
  ) {
...
@Composable
internal fun ZuvixSystemBarAppearance(lightAppearance: Boolean) {
...
fun overlayContainerColor(): Color {
  ...
  val isDark = LocalZuvixDarkTheme.current
