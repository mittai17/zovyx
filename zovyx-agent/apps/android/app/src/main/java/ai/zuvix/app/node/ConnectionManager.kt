...
import ai.zuvix.app.SecurePrefs
import ai.zuvix.app.VoiceWakeMode
import ai.zuvix.app.gateway.GatewayClientInfo
import ai.zuvix.app.gateway.GatewayConnectOptions
import ai.zuvix.app.gateway.GatewayEndpoint
import ai.zuvix.app.gateway.GatewayTlsParams
import ai.zuvix.app.gateway.isLocalCleartextGatewayHost
import ai.zuvix.app.gateway.isLoopbackGatewayHost
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "ZuvixAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "zuvix-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "zuvix-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
