...
/** Capability ids advertised by the Android node to the Zuvix gateway. */
enum class ZuvixCapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class ZuvixCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class ZuvixLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class ZuvixNotificationsCommand(
  val rawValue: String,
) {
...
enum class ZuvixContactsCommand(
  val rawValue: String,
) {
...
enum class ZuvixCalendarCommand(
  val rawValue: String,
) {
...
enum class ZuvixCallLogCommand(
  val rawValue: String,
) {
