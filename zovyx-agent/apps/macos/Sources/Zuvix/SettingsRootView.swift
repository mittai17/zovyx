...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .zuvixSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ZuvixPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ZuvixPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "Zuvix", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let zuvixSelectSettingsTab = Notification.Name("zuvixSelectSettingsTab")
}
