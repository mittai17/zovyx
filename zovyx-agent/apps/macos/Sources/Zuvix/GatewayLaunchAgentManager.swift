...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.zuvix", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".zuvix/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.zuvixCommand(
            subcommand: "gateway",
