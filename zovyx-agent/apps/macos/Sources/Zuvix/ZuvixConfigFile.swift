...
enum ZuvixConfigFile {
    private static let logger = Logger(subsystem: "ai.zuvix", category: "config")
    ...
    static func url() -> URL {
        ZuvixPaths.configURL
    }

    static func stateDirURL() -> URL {
        ZuvixPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ZuvixPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-zuvix-config-file",
            "event": "config.write",
