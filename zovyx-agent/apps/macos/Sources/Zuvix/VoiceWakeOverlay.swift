...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.zuvix", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Zuvix windows, but below the system’s pop-up menus.
