...
enum DebugActions {
    private static let verboseDefaultsKey = "zuvix.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "zuvix.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Zuvix", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = ZuvixPaths.configURL
        guard
