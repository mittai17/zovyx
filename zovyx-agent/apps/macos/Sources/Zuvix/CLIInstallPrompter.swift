...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.zuvix", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Zuvix CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .zuvixSelectSettingsTab, object: tab)
        }
    }
