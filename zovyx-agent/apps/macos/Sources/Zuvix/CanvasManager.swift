...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.zuvix", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Zuvix/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__zuvix__/a2ui/").absoluteString + "?platform=macos"
    }
