...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.zuvix", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> ZuvixSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: ZuvixSessionPreviewEntry,
    ...
    private static func cache(payload: ZuvixSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: ZuvixChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [ZuvixKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [ZuvixKit.AnyCodable]) -> [ZuvixChatMessage] {
    ...
    private static func previewText(for message: ZuvixChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: ZuvixChatMessage) -> Bool {
    ...
    private static func toolNames(for message: ZuvixChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: ZuvixChatMessage) -> String? {
