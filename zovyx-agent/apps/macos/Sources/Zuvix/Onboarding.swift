...
enum UIStrings {
    static let welcomeTitle = "Welcome to Zuvix"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ZuvixChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g zuvix@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ZuvixChatViewModel(
