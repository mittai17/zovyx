...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.zuvix", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ZuvixConfigFile.defaultWorkspaceURL() }
