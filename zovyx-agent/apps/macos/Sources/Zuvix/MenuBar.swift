...
struct ZuvixApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.zuvix", category: "app")
    ...
    var body: some Scene {
        ...
        Window("Zuvix Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "Zuvix - Voice Wake live meter active"
            : "Zuvix"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.zuvix", category: "Chat")
