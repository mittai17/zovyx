...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/zuvix/zuvix") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/zuvix/zuvix")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://zuvix.ai")
            ...
            Text("© 2026 Zuvix Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ZuvixBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ZuvixBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ZuvixGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ZuvixGitCommit") as? String) ??
            "unknown"
    }
