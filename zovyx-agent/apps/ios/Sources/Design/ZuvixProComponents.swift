...
struct ZuvixProBackground: View {
...
struct ProCard<Content: View>: View {
    ...
    var radius: CGFloat = ZuvixProMetric.cardRadius
    ...
    var body: some View {
        ...
        shape
            ...
            .overlay {
                if self.isProminent {
                    shape.strokeBorder(
                        ZuvixBrand.accent.opacity(self.colorScheme == .dark ? 0.12 : 0.07),
                        lineWidth: 1)
                        .padding(1)
                }
            }
...
extension View {
    func proPanelSurface(
        tint: Color? = nil,
        radius: CGFloat = ZuvixProMetric.cardRadius,
...
struct ZuvixSidebarHeaderAction {
    let systemName: String
...
struct ZuvixSidebarRevealButton: View {
    let headerAction: ZuvixSidebarHeaderAction

    init(action: ZuvixSidebarHeaderAction) {
...
struct ZuvixSidebarHeaderLeadingSlot: View {
    let action: ZuvixSidebarHeaderAction

    var body: some View {
        ZuvixSidebarRevealButton(action: self.action)
            .frame(width: 44, height: 44, alignment: .center)
    }
}

struct ZuvixAdaptiveHeaderRow<Leading: View, Accessory: View>: View {
    let title: String
    let subtitle: String
...
struct ZuvixProMark: View {
    ...
    var body: some View {
        Image("ZuvixIcon")
            ...
            .shadow(color: ZuvixBrand.accent.opacity(0.18), radius: self.shadowRadius, y: self.shadowRadius / 3)
            .accessibilityLabel("Zuvix")
    }
}

struct ProProgressBar: View {
    let progress: Double
    var color: Color = ZuvixBrand.accentHot
...
struct ZuvixGatewayCompactPill: View {
