...
struct IPadSkillWorkshopScreen: View {
    ...
    init(headerLeadingAction: ZuvixSidebarHeaderAction? = nil, openSettings: @escaping () -> Void = {}) {
...
private struct IPadSkillProposalKanbanCard: View {
    ...
    var body: some View {
                    ...
                    HStack(alignment: .top, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text(self.proposal.title)
                                .font(.subheadline.weight(.semibold))
                                .foregroundStyle(self.isSelected ? ZuvixBrand.accent : .primary)
                                .lineLimit(2)
        ...
        .padding(12)
        .background(
            self.isSelected ? ZuvixBrand.accent.opacity(0.08) : Color.clear,
...
struct IPadSkillProposal: Identifiable {
    ...
    var statusColor: Color {
        switch self.status {
        case "pending": ZuvixBrand.warn
        case "applied": ZuvixBrand.ok
        case "rejected": .secondary
        case "quarantined", "stale": ZuvixBrand.warn
        default: ZuvixBrand.accent
        }
    }
