...
struct ChatProTab: View {
                ...
                VStack(spacing: 0) {
                    ...
                    if let viewModel {
                        ZuvixChatView(
                            ...
                            assistantAvatarTint: ZuvixBrand.accent,
                    ...
                    Circle()
                        .fill(
                            LinearGradient(
                                colors: [
                                    ZuvixBrand.accent,
                                    ZuvixBrand.accentHot,
                                ],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing)))
                .overlay(Circle().strokeBorder(.white.opacity(0.18), lineWidth: 1))
                .shadow(color: ZuvixBrand.accent.opacity(0.18), radius: 10, y: 5)
        } else {
            ProIconBadge(systemName: "bubble.left", color: ZuvixBrand.accent)
        }
    }
    ...
    private func syncChatViewModel() {
        ...
        guard let viewModel else {
            ...
            self.viewModel = ZuvixChatViewModel(
    ...
    private var talkControl: ZuvixChatTalkControl {
        ZuvixChatTalkControl(
    ...
    private var chatUserAccent: Color {
        self.colorScheme == .light ? Color(red: 0 / 255.0, green: 122 / 255.0, blue: 255 / 255.0) : ZuvixBrand.accent
    }
