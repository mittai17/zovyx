...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = ZuvixLocationMode.off.rawValue
    ...
    @State var previousLocationModeRaw: String = ZuvixLocationMode.off.rawValue
