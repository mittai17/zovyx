...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.zuvix.gateway"
    private static let nodeService = "ai.zuvix.node"
    private static let talkService = "ai.zuvix.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.zuvix.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.zuvix.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("zuvix-gateway.log")
    }
