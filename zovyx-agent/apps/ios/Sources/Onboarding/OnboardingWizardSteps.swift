...
struct OnboardingIntroStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ZuvixProMark(size: 64, shadowRadius: 14)
                .padding(.bottom, 18)
            ...
            Text("Turn this device into a secure Zuvix node for chat, voice, camera, and device tools.")
                .font(.subheadline)
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Label("Use Zuvix from your phone", systemImage: "message.fill")
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Text("Security notice")
                        .font(.headline)
                    Text(
                        "The connected Zuvix agent can use device capabilities you enable, "
...
struct OnboardingWelcomeStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Scan a QR code from your Zuvix gateway or continue with manual setup.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)
