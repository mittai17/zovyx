...
Zuvix is now available on iPhone.

Connect to your Zuvix Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.

## 2026.6.1 - 2026-06-01

Maintenance update for the current Zuvix release.
...
Maintenance update for the current Zuvix beta release.
...
Maintenance update for the current Zuvix development release.
...
First App Store release of Zuvix for iPhone. Pair with your Zuvix Gateway to use chat, voice, sharing, and device actions from iOS.
