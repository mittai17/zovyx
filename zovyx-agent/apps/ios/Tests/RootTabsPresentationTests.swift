...
@Suite struct RootTabsPresentationTests {
    ...
    @Test func chatSidebarDestinationCanUseRouteHeaderInsteadOfAgentBranding() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "Zuvix") == "Zuvix")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "Zuvix") == "Chat")
    }
