...
@Suite struct RootTabsSourceGuardTests {
    @Test func hiddenSidebarRevealUsesDestinationHeaderWithoutReservedRail() throws {
        ...
        #expect(componentSource.contains("ZuvixSidebarHeaderLeadingSlot"))
    ...
    @Test func sidebarKeepsNavigationModelDestinationOnly() throws {
        ...
        #expect(source.contains("ZuvixProMark(size: 30"))
        #expect(source.contains("Text(\"Zuvix\")"))
    ...
    @Test func sidebarRoutesUseDestinationHeadersInsteadOfRepeatedProductBranding() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"Zuvix\""))
        #expect(agentOverviewSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"Zuvix\")"))
        #expect(docsSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"Zuvix Docs\")"))
    }
    ...
    @Test func agentsDirectRouteKeepsSingleSidebarControl() throws {
        ...
        #expect(nodesSource.contains("ZuvixSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("ZuvixSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func routedHeadersUseSharedAdaptiveLayout() throws {
        ...
        #expect(componentsSource.contains("struct ZuvixAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(docsSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(overviewSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(chatSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("ZuvixAdaptiveHeaderRow("))
        #expect(settingsSource.contains("ZuvixAdaptiveHeaderRow("))
    }
    ...
    @Test func phoneHubKeepsDocsAsDestinationOnly() throws {
        ...
        #expect(source.contains("ZuvixDocsScreen("))
        ...
        #expect(!source.contains("https://docs.zuvix.ai"))
    }
    ...
    @Test func phoneHubHeaderStaysTaskFirst() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: ZuvixSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"ZuvixPhoneDetailBackButton\""))
    ...
    @Test func activityScreenStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(!taskSource.contains("import ZuvixChatUI"))
    ...
    @Test func routedFeatureChromeStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(chromeSource.contains("ZuvixSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("ZuvixGatewayCompactPill()"))
    ...
    @Test func routedGatewayPillsOpenGatewaySettings() throws {
        ...
        #expect(agentOverviewSource.contains("ZuvixGatewayCompactPill()"))
    ...
    @Test func gatewaySettingsKeepsPairingTrustDiagnosticsAndTailscaleActions() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your Zuvix chat"))
    ...
    @Test func gatewaySettingsPreviewMatrixCoversPrimaryStates() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your Zuvix chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/ZuvixProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/ZuvixDocsScreen.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/ZuvixKit/Sources/ZuvixChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Zuvix.xcodeproj/project.pbxproj")
    }
