...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "zuvix devices approve req-123",
            docsURLString: "https://docs.zuvix.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "zuvix devices approve req-123")
        #expect(error.docsURLString == "https://docs.zuvix.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "zuvix devices approve req-123")
    }
