...
private struct AttachmentProcessingTransport: ZuvixChatTransport {
    func requestHistory(sessionKey _: String) async throws -> ZuvixChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            ZuvixChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
