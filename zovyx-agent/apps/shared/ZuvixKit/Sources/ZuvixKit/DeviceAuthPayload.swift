...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: ZuvixProtocol.AnyCodable]?
    {
        ...
        return [
            "id": ZuvixProtocol.AnyCodable(identity.deviceId),
            "publicKey": ZuvixProtocol.AnyCodable(publicKey),
            "signature": ZuvixProtocol.AnyCodable(signature),
            "signedAt": ZuvixProtocol.AnyCodable(signedAtMs),
            "nonce": ZuvixProtocol.AnyCodable(nonce),
        ]
    }
}
