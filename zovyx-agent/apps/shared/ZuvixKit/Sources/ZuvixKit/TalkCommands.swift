...
public enum ZuvixTalkCommand: String, Codable, Sendable {
...
public struct ZuvixTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ZuvixTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
