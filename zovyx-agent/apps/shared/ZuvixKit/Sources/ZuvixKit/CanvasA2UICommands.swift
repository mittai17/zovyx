...
public enum ZuvixCanvasA2UICommand: String, Codable, Sendable {
...
public struct ZuvixCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ZuvixCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
