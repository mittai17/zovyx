...
public struct ZuvixChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct ZuvixChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct ZuvixChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [ZuvixChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [ZuvixChatThinkingLevelOption]? = nil,
...
public struct ZuvixChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct ZuvixChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: ZuvixChatSessionsDefaults?
    public let sessions: [ZuvixChatSessionEntry]
    ...
    public init(
        ...
        sessions: [ZuvixChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
