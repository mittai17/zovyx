...
public typealias ZuvixPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ZuvixPlatformImage = UIImage
#endif

public struct ZuvixChatUsageCost: Codable, Hashable, Sendable {
...
public struct ZuvixChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ZuvixChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ZuvixChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ZuvixChatMessageContent: Codable, Hashable, Sendable {
...
public struct ZuvixChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ZuvixChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ZuvixChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ZuvixChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ZuvixChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(ZuvixChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([ZuvixChatMessageContent].self, forKey: .content) {
...
public struct ZuvixChatHistoryPayload: Codable, Sendable {
...
public struct ZuvixSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ZuvixSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ZuvixSessionPreviewItem]
}

public struct ZuvixSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ZuvixSessionPreviewEntry]

    public init(ts: Int, previews: [ZuvixSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ZuvixChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ZuvixChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct ZuvixChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ZuvixSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: ZuvixChatMessage?
...
public struct ZuvixAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ZuvixChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct ZuvixGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ZuvixPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ZuvixPlatformImage?
...
public struct ZuvixChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
