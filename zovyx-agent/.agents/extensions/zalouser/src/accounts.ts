...
function mergeZalouserAccountConfig(cfg: ZuvixConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: ZuvixConfig; accountId?: string | null }) {
