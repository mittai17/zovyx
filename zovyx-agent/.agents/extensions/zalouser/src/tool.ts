...
import { stringEnum } from "zuvix/plugin-sdk/channel-actions";
import type { AnyAgentTool, ZuvixPluginToolContext } from "zuvix/plugin-sdk/core";
...
type ZalouserToolContext = Pick<ZuvixPluginToolContext, "deliveryContext">;
