...
function ensureZalouserPluginEnabled(cfg: ZuvixConfig): ZuvixConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("zuvix directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("zuvix directory groups list --channel zalouser"),
            }),
