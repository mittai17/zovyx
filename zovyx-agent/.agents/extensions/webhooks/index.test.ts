...
function createApi(params?: {
  pluginConfig?: ZuvixPluginApi["pluginConfig"];
  registerHttpRoute?: ZuvixPluginApi["registerHttpRoute"];
  logger?: ZuvixPluginApi["logger"];
}): ZuvixPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<ZuvixPluginApi["registerHttpRoute"]>[0];
}
