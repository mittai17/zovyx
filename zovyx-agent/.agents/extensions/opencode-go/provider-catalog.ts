...
import type { ModelCatalogEntry } from "zuvix/plugin-sdk/agent-runtime";
...
import { normalizeModelCompat } from "zuvix/plugin-sdk/provider-model-shared";
import type {
...
const OPENCODE_GO_OPENAI_BASE_URL = "https://zuvix.ai/zen/go/v1";
const OPENCODE_GO_ANTHROPIC_BASE_URL = "https://zuvix.ai/zen/go";
const OPENCODE_GO_KIMI_NO_REASONING_MODEL_IDS = new Set(["kimi-k2.5", "kimi-k2.6"]);
const OPENCODE_GO_MODELS_ENDPOINT = "https://zuvix.ai/zen/go/v1/models";
...
export async function buildOpencodeGoLiveProviderConfig(
  ...
  return await buildLiveModelProviderConfig({
    ...
    auditContext: "zuvix-go-model-discovery",
  });
}
...
export function normalizeOpencodeGoBaseUrl(params: {
  ...
  if (normalized === "https://zuvix.ai/go") {
    return OPENCODE_GO_ANTHROPIC_BASE_URL;
  }
  if (normalized === "https://zuvix.ai/go/v1") {
