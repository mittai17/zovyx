...
import { safeParseJsonWithSchema, safeParseWithSchema } from "zuvix/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "zuvix/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "zuvix/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: ZuvixConfig): ResolvedGoogleChatAccount[] {
