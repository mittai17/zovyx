...
import { recordChannelBotPairLoopAndCheckSuppression } from "zuvix/plugin-sdk/channel-inbound";
  ...
  it("creates typing messages by default", async () => {
    ...
    const core = {
      ...
      channel: {
        ...
        session: {
          resolveStorePath: () => "/tmp/zuvix-googlechat-test",
