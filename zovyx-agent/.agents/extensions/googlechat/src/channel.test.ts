...
function resolveGoogleChatAccountImpl(params: { cfg: ZuvixConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: ZuvixConfig) => {
...
function createGoogleChatCfg(): ZuvixConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
