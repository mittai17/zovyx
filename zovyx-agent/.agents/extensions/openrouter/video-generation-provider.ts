...
import { isRecord, normalizeOptionalString } from "zuvix/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "zuvix/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("zuvix.videoGeneration.supportedDurations");
