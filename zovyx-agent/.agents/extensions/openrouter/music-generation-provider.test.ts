...
import { expectExplicitMusicGenerationCapabilities } from "zuvix/plugin-sdk/provider-test-contracts";
...
vi.mock("zuvix/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("zuvix/plugin-sdk/provider-http")>();
  return {
    ...original,
