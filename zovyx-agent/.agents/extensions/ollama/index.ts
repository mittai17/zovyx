// Ollama plugin entrypoint registers its Zuvix integration.
import { collectConfiguredModelRefValues } from "@zuvix/model-catalog-core/configured-model-refs";
...
export default definePluginEntry({
  ...
  register(api: ZuvixPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: ZuvixConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "zuvix onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.zuvix.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "zuvix configure". ' +
        "See: https://docs.zuvix.ai/providers/ollama",
    });
  },
});
