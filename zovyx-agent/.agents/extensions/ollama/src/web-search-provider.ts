...
import { resolveEnvApiKey } from "zuvix/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: ZuvixConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: ZuvixConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: ZuvixConfig): string {
