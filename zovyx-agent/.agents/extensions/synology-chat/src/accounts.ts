...
import { resolveDangerousNameMatchingEnabled } from "zuvix/plugin-sdk/dangerous-name-runtime";
import { parseStrictInteger } from "zuvix/plugin-sdk/number-runtime";
...
/** Extract the channel config from the full Zuvix config object. */
function getChannelConfig(cfg: ZuvixConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: ZuvixConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.ZUVIX_BOT_NAME ?? "Zuvix";
