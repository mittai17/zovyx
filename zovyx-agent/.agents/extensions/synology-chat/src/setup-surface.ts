...
function getChannelConfig(cfg: ZuvixConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: ZuvixConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: ZuvixConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: ZuvixConfig, accountId: string): string[] {
