...
import { DEFAULT_ACCOUNT_ID, type ZuvixConfig } from "zuvix/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "zuvix/plugin-sdk/webhook-ingress";
