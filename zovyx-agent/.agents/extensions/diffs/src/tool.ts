...
import { optionalFiniteNumberSchema, stringEnum } from "zuvix/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, ZuvixPluginApi, ZuvixPluginToolContext } from "../api.js";
...
export function createDiffsTool(params: {
  ...
  context?: ZuvixPluginToolContext;
}): AnyAgentTool {
  return {
    name: "diffs",
    label: "Diffs",
...
function buildArtifactContext(
  context: ZuvixPluginToolContext | undefined,
