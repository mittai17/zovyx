...
const PHONE_CONTROL_STATE_PREFIX = "zuvix-phone-control-test-";
...
function createApi(params: {
  ...
  openKeyedStore?: ZuvixPluginApi["runtime"]["state"]["openKeyedStore"];
}): ZuvixPluginApi {
...
}): ZuvixPluginApi["runtime"]["state"]["openKeyedStore"] {
  return <T>() => {
...
describe("phone-control plugin", () => {
  ...
  it("does not block service startup on the initial expiry check", async () => {
    ...
    try {
      ...
      let service: ZuvixPluginService | undefined;
