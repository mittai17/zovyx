...
import type { MigrationItem } from "zuvix/plugin-sdk/plugin-entry";
import { appendRegularFile, pathExists } from "zuvix/plugin-sdk/security-runtime";
import { isRecord as sharedIsRecord } from "zuvix/plugin-sdk/string-coerce-runtime";
