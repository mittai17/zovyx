...
Nostr DM channel plugin for Zuvix using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Zuvix. It enables your bot to:
...
# Configure zuvix to use local relay
