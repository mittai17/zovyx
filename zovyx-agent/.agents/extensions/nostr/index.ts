// Nostr plugin entrypoint registers its Zuvix integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "zuvix/plugin-sdk/channel-entry-contract";
import type { ZuvixConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as ZuvixConfig;
