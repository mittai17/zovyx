...
import { normalizeSecretInputString, type SecretInput } from "zuvix/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: ZuvixConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: ZuvixConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: ZuvixConfig): string {
