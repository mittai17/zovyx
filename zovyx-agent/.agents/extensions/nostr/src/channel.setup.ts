...
function getNostrConfig(cfg: ZuvixConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: ZuvixConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: ZuvixConfig): string {
