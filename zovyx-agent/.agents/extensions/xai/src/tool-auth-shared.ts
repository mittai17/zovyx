...
function readLegacyGrokFallbackAuth(cfg?: ZuvixConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: ZuvixConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: ZuvixConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: ZuvixConfig): string | undefined {
