...
} from "zuvix/plugin-sdk/param-readers";
...
type BoundTaskFlow = ReturnType<
  NonNullable<ZuvixPluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: ZuvixPluginApi, options?: LobsterToolOptions) {
