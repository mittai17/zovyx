...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "zuvix" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "zuvix" };
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("zuvix", {
