/**
 * Amazon Bedrock Converse streaming runtime. It maps Zuvix messages/tools,
...
/** Stream a Bedrock Converse request from the generic Zuvix stream options. */
 ...
 * Defaults to "short" and uses ZUVIX_CACHE_RETENTION for backward compatibility.
 */
