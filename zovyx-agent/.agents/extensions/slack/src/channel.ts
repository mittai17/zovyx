...
} from "zuvix/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "zuvix/plugin-sdk/channel-config-helpers";
import {
  buildThreadAwareOutboundSessionRoute,
  createChatChannelPlugin,
} from "zuvix/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "zuvix/plugin-sdk/channel-outbound";
import { resolveOutboundSendDep } from "zuvix/plugin-sdk/channel-outbound";
import { createPairingPrefixStripper } from "zuvix/plugin-sdk/channel-pairing";
import {
  createAttachedChannelResultAdapter,
  type ChannelOutboundAdapter,
} from "zuvix/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "zuvix/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "zuvix/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "zuvix/plugin-sdk/routing";
import {
...
//
// `zuvix/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "zuvix/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "zuvix/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as ZuvixConfig, toolContext as SlackActionContext | undefined),
    }),
