      ...
      lines: [
        {
          ...
          icon: "🛠️",
          label: "Exec",
          detail: "run tests in /Users/example/Projects/zuvix/packages/very/deep/path/example",
          text: "🛠️ Exec: run tests in /Users/example/Projects/zuvix/packages/very/deep/path/example",
        },
      ],
    });
