...
import type { ZuvixPluginApi } from "zuvix/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: ZuvixPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: ZuvixPluginApi): void {
