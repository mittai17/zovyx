...
import { resolveDefaultAgentId } from "zuvix/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "zuvix/plugin-sdk/allow-from";
import type {
  ZuvixConfig,
  SlackReactionNotificationMode,
} from "zuvix/plugin-sdk/config-contracts";
import type { SessionScope } from "zuvix/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "zuvix/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "zuvix/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "zuvix/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "zuvix/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("zuvix/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
