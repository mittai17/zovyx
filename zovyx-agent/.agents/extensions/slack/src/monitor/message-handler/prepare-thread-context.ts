...
import { formatInboundEnvelope } from "zuvix/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "zuvix/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "zuvix/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("zuvix/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
