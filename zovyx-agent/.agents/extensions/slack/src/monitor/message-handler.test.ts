...
vi.mock("zuvix/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/channel-inbound")>(
    "zuvix/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
