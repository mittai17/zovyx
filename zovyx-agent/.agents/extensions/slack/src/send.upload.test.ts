...
vi.mock("zuvix/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/fetch-runtime")>(
    "zuvix/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
