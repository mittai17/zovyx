...
} from "zuvix/plugin-sdk/channel-route";
import type { ZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
import { normalizeMessageChannel } from "zuvix/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<ZuvixConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: ZuvixConfig) {
