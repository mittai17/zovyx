...
import { createDangerousNameMatchingMutableAllowlistWarningCollector } from "zuvix/plugin-sdk/channel-policy";
...
function collectSlackNameKeyedChannelWarnings({ cfg }: { cfg: ZuvixConfig }): string[] {
