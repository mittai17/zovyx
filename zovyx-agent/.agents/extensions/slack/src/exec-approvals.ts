...
import { doesApprovalRequestMatchChannelAccount } from "zuvix/plugin-sdk/approval-native-runtime";
import type { ZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
import { normalizeStringifiedOptionalString } from "zuvix/plugin-sdk/string-coerce-runtime";
...
function resolveSlackOwnerApprovers(cfg: ZuvixConfig): string[] {
