...
import { buildApprovalPresentationFromActionDescriptors } from "zuvix/plugin-sdk/approval-reply-runtime";
import type { ZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
import { logError } from "zuvix/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<ZuvixConfig["channels"]>["slack"]>["execApprovals"]
>;
