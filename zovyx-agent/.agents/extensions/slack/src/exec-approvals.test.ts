...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<ZuvixConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<ZuvixConfig["channels"]>["slack"]>>,
): ZuvixConfig {
  return {
    channels: {
      slack: {
