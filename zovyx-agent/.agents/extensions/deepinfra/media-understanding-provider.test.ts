...
vi.mock("zuvix/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/media-understanding")>(
    "zuvix/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("zuvix/plugin-sdk/media-understanding");
  vi.resetModules();
});
