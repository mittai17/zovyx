...
import { resolveNormalizedAccountEntry } from "zuvix/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "zuvix/plugin-sdk/channel-core";
import { getChatChannelMeta } from "zuvix/plugin-sdk/channel-plugin-common";
import type { ZuvixConfig, TelegramAccountConfig } from "zuvix/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/zuvix/zuvix/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: ZuvixConfig, accountId: string): boolean {
