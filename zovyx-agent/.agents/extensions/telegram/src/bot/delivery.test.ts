...
vi.mock("zuvix/plugin-sdk/media-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("zuvix/plugin-sdk/media-runtime")>();
  return {
    ...actual,
...
vi.mock("zuvix/plugin-sdk/hook-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("zuvix/plugin-sdk/hook-runtime")>();
  return {
    ...actual,
    triggerInternalHook,
  };
...
vi.mock("zuvix/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("zuvix/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
