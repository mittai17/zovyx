...
export function shouldShowTelegramDmAccessWarning(cfg: ZuvixConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`zuvix config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`zuvix config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
