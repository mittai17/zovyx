...
import type { MessagePresentation } from "zuvix/plugin-sdk/interactive-runtime";
...
function resolveActionTopicNameCacheScope(cfg: ZuvixConfig, accountId?: string | null): string {
