...
import { CURRENT_MESSAGE_MARKER } from "zuvix/plugin-sdk/channel-mention-gating";
import {
...
import type { BlockReplyContext } from "zuvix/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: ZuvixConfig, agentId: string) {
  try {
