...
vi.mock("zuvix/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/hook-runtime")>(
    "zuvix/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
