...
import type { ChannelSetupAdapter } from "zuvix/plugin-sdk/setup-runtime";
import {
...
export function getTelegramTokenHelpLines(): string[] {
  return [
    ...
    t("wizard.telegram.website", { url: "https://zuvix.ai" }),
  ];
}
...
export function getTelegramUserIdHelpLines(): string[] {
  return [
    t("wizard.telegram.userIdHelpLogs", {
      command: formatCliCommand("zuvix logs --follow"),
    }),
