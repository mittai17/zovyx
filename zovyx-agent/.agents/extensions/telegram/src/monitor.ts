...
import { resolveAgentMaxConcurrent } from "zuvix/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: ZuvixConfig): RunOptions<unknown> {
  return {
    sink: {
