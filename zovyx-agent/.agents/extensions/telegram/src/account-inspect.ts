...
import { resolveAccountWithDefaultFallback } from "zuvix/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "zuvix/plugin-sdk/channel-core";
import type { ZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "zuvix/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "zuvix/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "zuvix/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "zuvix/plugin-sdk/secret-input";
import { coerceSecretRef } from "zuvix/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "zuvix/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: ZuvixConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: ZuvixConfig): boolean {
