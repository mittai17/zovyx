...
import { isTruthyEnvValue, isWSL2Sync } from "zuvix/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "zuvix/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ZUVIX_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ZUVIX_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ZUVIX_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ZUVIX_TELEGRAM_DNS_RESULT_ORDER
