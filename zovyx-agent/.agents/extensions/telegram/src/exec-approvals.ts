...
import { resolveApprovalApprovers } from "zuvix/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "zuvix/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "zuvix/plugin-sdk/approval-runtime";
import type { ZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "zuvix/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: ZuvixConfig): Array<string | number> {
