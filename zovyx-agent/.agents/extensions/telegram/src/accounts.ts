...
import { formatSetExplicitDefaultInstruction } from "zuvix/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "zuvix/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ZUVIX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: ZuvixConfig): ResolvedTelegramAccount[] {
