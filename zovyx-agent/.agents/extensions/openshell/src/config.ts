...
import { buildPluginConfigSchema, type ZuvixPluginConfigSchema } from "zuvix/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "zuvix/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "zuvix/plugin-sdk/number-runtime";
import { z } from "zod";
...
export function createOpenShellPluginConfigSchema(): ZuvixPluginConfigSchema {
