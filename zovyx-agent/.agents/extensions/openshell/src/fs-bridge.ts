...
import { root as fsRoot } from "zuvix/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "zuvix/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "zuvix/plugin-sdk/sandbox";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".zuvix", "sandbox-skills", "skills"] as const;
