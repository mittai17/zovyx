...
import { createLoggedPairingApprovalNotifier } from "zuvix/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "zuvix/plugin-sdk/channel-policy";
import {
...
import { createChannelDirectoryAdapter } from "zuvix/plugin-sdk/directory-runtime";
import { buildPassiveProbedChannelStatusSummary } from "zuvix/plugin-sdk/extension-shared";
import {
  type MessagePresentation,
  normalizeMessagePresentation,
  renderMessagePresentationFallbackText,
  resolveMessagePresentationControlValue,
} from "zuvix/plugin-sdk/interactive-runtime";
import { createLazyRuntimeModule } from "zuvix/plugin-sdk/lazy-runtime";
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "zuvix/plugin-sdk/reply-payload";
import { isPrivateNetworkOptInEnabled } from "zuvix/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "Zuvix: your access has been approved.",
