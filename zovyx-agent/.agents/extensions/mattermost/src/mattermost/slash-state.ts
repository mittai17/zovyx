 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("zuvix.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").ZuvixConfig;
 ...
 */
export function registerSlashCommandRoute(api: ZuvixPluginApi) {
