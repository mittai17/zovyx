...
import { createClaimableDedupe } from "zuvix/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: ZuvixConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<ZuvixConfig["channels"]>["mattermost"]>;
