...
import type { PluginHookInboundClaimEvent } from "zuvix/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "zuvix/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Zuvix channels expose either local staged files or remote URLs. Keep
