/**
 * Projects Zuvix context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "zuvix/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "Zuvix assembled context for this turn:";
...
/** Projects assembled Zuvix context-engine messages into Codex prompt inputs. */
