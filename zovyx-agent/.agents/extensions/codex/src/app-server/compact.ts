/**
 * Native Codex app-server compaction bridge for bound Zuvix sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringZuvixCompactionOverrides(params);
...
function warnIfIgnoringZuvixCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
