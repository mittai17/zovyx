/**
 * Mirrors Codex native subagent thread lifecycle events into Zuvix task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "zuvix/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the Zuvix task-runtime run id. */
