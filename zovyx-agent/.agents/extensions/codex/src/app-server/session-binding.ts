...
import { type FileLockOptions, withFileLock } from "zuvix/plugin-sdk/file-lock";
import {
...
/** Durable sidecar binding connecting an Zuvix session file to a Codex thread. */
