...
import {
  ...
  resolveCodexExternalSandboxPolicyForZuvixSandbox,
          ...
          try {
            ...
            try {
              ...
              if (
                ...
                throw new Error(
                  "Codex app-server did not register an Zuvix sandbox exec-server environment.",
                );
              }
            } catch (error) {
              await releaseStartupSandboxEnvironment();
            ...
            const startupSandboxPolicy = startupSandboxEnvironment
              ? resolveCodexExternalSandboxPolicyForZuvixSandbox(params.sandbox)
              : undefined;
