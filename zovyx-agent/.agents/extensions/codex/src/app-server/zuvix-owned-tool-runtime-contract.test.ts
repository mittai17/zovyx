// Codex tests cover zuvix owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "zuvix/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "zuvix/plugin-sdk/agent-harness-runtime";
import {
...
describe("Zuvix-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetZuvixOwnedToolHooks();
  });
