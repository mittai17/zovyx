// File Transfer plugin entrypoint registers its Zuvix integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type ZuvixPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: ZuvixPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
