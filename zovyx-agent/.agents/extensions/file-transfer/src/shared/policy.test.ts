...
// without touching ~/.zuvix/zuvix.json.
...
vi.mock("zuvix/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("zuvix/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("zuvix/plugin-sdk/config-mutation");
  vi.resetModules();
});
