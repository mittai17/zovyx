...
import type { ZuvixConfig as RuntimeApiZuvixConfig } from "zuvix/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiZuvixConfig["channels"]>["imessage"]>,
