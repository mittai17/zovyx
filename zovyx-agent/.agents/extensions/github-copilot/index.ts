// Github Copilot plugin entrypoint registers its Zuvix integration.
...
import { getCachedLiveCatalogValue } from "zuvix/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: ZuvixConfig): ZuvixConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: ZuvixConfig): GithubCopilotPluginConfig {
