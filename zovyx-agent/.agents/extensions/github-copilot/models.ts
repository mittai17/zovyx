...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "zuvix/plugin-sdk/provider-auth";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in zuvix.json — no
