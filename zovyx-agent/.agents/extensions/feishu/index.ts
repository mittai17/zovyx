// Feishu plugin entrypoint registers its Zuvix integration.
import {
...
function registerFeishuDocTools(api: ZuvixPluginApi) {
...
function registerFeishuChatTools(api: ZuvixPluginApi) {
  const register = loadBundledEntryExportSync<(api: ZuvixPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: ZuvixPluginApi) {
  const register = loadBundledEntryExportSync<(api: ZuvixPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: ZuvixPluginApi) {
  const register = loadBundledEntryExportSync<(api: ZuvixPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: ZuvixPluginApi) {
  const register = loadBundledEntryExportSync<(api: ZuvixPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: ZuvixPluginApi) {
  const register = loadBundledEntryExportSync<(api: ZuvixPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
