// Deepseek plugin entrypoint registers its Zuvix integration.
import { readConfiguredProviderCatalogEntries } from "zuvix/plugin-sdk/provider-catalog-shared";
...
import { fetchDeepSeekUsage } from "zuvix/plugin-sdk/provider-usage";
