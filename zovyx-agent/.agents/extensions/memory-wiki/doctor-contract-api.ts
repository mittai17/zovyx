...
import type { PluginDoctorStateMigration } from "zuvix/plugin-sdk/runtime-doctor";
...
function readConfiguredPluginConfig(config: ZuvixConfig): MemoryWikiPluginConfig | undefined {
