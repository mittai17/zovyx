...
import { readFiniteNumberParam } from "zuvix/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- zuvix:wiki:generated:start -->";
const GENERATED_END = "<!-- zuvix:wiki:generated:end -->";
const HUMAN_START = "<!-- zuvix:human:start -->";
const HUMAN_END = "<!-- zuvix:human:end -->";
