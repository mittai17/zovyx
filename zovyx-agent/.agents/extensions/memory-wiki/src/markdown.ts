...
export const WIKI_RELATED_START_MARKER = "<!-- zuvix:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- zuvix:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- zuvix:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- zuvix:human:start -->";
const HUMAN_END_MARKER = "<!-- zuvix:human:end -->";
