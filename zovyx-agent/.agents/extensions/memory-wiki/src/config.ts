...
import { mapPluginConfigIssues } from "zuvix/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type ZuvixPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: ZuvixPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".zuvix", "wiki", "main");
}
