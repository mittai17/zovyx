...
import { resolveDefaultAgentId } from "zuvix/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "zuvix/plugin-sdk/param-readers";
import type { ZuvixConfig, ZuvixPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<ZuvixPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: ZuvixConfig | undefined,
): string | undefined {
  return (
