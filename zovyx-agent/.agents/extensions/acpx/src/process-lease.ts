/**
 * Persistent lease store for ACPX wrapper processes. Leases let Zuvix attach
...
export const ZUVIX_ACPX_LEASE_ID_ENV = "ZUVIX_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const ZUVIX_GATEWAY_INSTANCE_ID_ENV = "ZUVIX_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const ZUVIX_ACPX_LEASE_ID_ARG = "--zuvix-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const ZUVIX_GATEWAY_INSTANCE_ID_ARG = "--zuvix-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${ZUVIX_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${ZUVIX_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
