...
import type { ZuvixPluginService, ZuvixPluginServiceContext } from "zuvix/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: ZuvixPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpRuntime | null;
  realService: ZuvixPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpRuntime> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as ZuvixPluginServiceContext);
