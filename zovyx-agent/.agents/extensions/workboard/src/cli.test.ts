...
vi.mock("zuvix/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/gateway-runtime")>(
    "zuvix/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
...
vi.mock("zuvix/plugin-sdk/runtime-config-snapshot", () => ({
