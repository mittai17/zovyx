...
import type { ProviderAuthContext, ProviderAuthResult } from "zuvix/plugin-sdk/plugin-entry";
import type { ProviderAuthMethod } from "zuvix/plugin-sdk/plugin-entry";
