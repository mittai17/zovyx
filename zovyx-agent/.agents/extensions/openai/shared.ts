...
import { findCatalogTemplate } from "zuvix/plugin-sdk/provider-catalog-shared";
import {
  cloneFirstTemplateModel,
  matchesExactOrPrefix,
  type ProviderPlugin,
} from "zuvix/plugin-sdk/provider-model-shared";
import { OPENAI_RESPONSES_STREAM_HOOKS } from "zuvix/plugin-sdk/provider-stream-family";
...
export function resolveConfiguredOpenAIBaseUrl(cfg: ZuvixConfig | undefined): string {
