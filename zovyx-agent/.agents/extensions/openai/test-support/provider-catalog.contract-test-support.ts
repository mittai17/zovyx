...
import type { ProviderPlugin } from "zuvix/plugin-sdk/provider-test-contracts";
...
vi.mock("zuvix/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("zuvix/plugin-sdk/provider-catalog-runtime")
  >("zuvix/plugin-sdk/provider-catalog-runtime");
