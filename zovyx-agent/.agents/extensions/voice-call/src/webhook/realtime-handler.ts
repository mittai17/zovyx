...
const FORCED_CONSULT_REASON = "provider_final_transcript_without_zuvix_agent_consult";
...
function buildForcedConsultSpeechPrompt(result: string): string {
  ...
  return [
    "Internal Zuvix consult result is ready.",
...
export class RealtimeCallHandler {
  ...
  constructor(
    ...
    private readonly coreConfig?: ZuvixConfig,
  ) {}
