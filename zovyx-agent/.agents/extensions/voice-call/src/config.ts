...
import { REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES } from "zuvix/plugin-sdk/realtime-voice";
import {
...
const VoiceCallRealtimeConfigSchema = z
  .object({
    ...
    /** Tool policy for the shared Zuvix agent consult tool. */
    toolPolicy: VoiceCallRealtimeToolPolicySchema.default("safe-read-only"),
    /** Guidance for when the realtime model should call the Zuvix agent consult tool. */
