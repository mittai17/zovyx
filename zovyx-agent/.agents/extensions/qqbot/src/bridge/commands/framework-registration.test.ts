...
function registerCommands(): ZuvixPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: ZuvixPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: ZuvixPluginCommandDefinition) => {
...
function findCommand(
  commands: ZuvixPluginCommandDefinition[],
  name: string,
): ZuvixPluginCommandDefinition {
