...
function mergeZaloAccountConfig(cfg: ZuvixConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ZuvixConfig): ResolvedZaloAccount[] {
