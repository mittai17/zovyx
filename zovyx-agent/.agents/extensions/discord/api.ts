...
// Deprecated compatibility surface for existing @zuvix/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "zuvix/plugin-sdk/runtime-group-policy";
