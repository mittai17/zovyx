...
function createCfg(): ZuvixConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: ZuvixConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: ZuvixConfig, accountId = "default") {
