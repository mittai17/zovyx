...
import { peekSystemEvents, resetSystemEventsForTest } from "zuvix/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): ZuvixConfig => ({}) as ZuvixConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`zuvix pairing approve discord ${code}`);
