...
import { resolveCommandAuthorizedFromAuthorizers } from "zuvix/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: ZuvixConfig): string[] | undefined {
