...
import { danger, warn, type RuntimeEnv } from "zuvix/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("zuvix/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("zuvix/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("zuvix/plugin-sdk/plugin-runtime");
