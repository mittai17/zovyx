...
import { asDateTimestampMs, parseStrictPositiveInteger } from "zuvix/plugin-sdk/number-runtime";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "ZUVIX_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "ZUVIX_DISCORD_RUNTIME_READY_TIMEOUT_MS";
