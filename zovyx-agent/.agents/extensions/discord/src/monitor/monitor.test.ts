...
import { buildPluginBindingApprovalCustomId } from "zuvix/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/zuvix-sessions-test.json");
