...
import * as pluginCommandsModule from "zuvix/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "zuvix/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: ZuvixConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: ZuvixConfig) => void;
