...
import type { ModelsProviderData } from "zuvix/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "zuvix/plugin-sdk/number-runtime";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("zuvix/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("zuvix/plugin-sdk/models-provider-runtime");
