...
import { resolveAckReaction, resolveHumanDelayConfig } from "zuvix/plugin-sdk/agent-runtime";
import {
...
import { getAgentScopedMediaLocalRoots } from "zuvix/plugin-sdk/media-runtime";
import { resolveChunkMode } from "zuvix/plugin-sdk/reply-chunking";
...
import type { ReplyDispatchKind, ReplyPayload } from "zuvix/plugin-sdk/reply-runtime";
...
let replyRuntimePromise: Promise<typeof import("zuvix/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("zuvix/plugin-sdk/reply-runtime");
