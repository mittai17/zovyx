...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "zuvix/plugin-sdk/routing";
import {
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("zuvix.discordThreadBindingsState");
