...
import type { ZuvixConfig, ReplyToMode } from "zuvix/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "zuvix/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "zuvix/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "zuvix/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "zuvix/plugin-sdk/runtime-env";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("zuvix/plugin-sdk/reply-history").HistoryEntry[]
    >();
