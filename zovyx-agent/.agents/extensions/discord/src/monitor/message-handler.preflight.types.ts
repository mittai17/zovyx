...
import type { InboundEventKind } from "zuvix/plugin-sdk/channel-inbound";
...
import type { SessionBindingRecord } from "zuvix/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "zuvix/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "zuvix/plugin-sdk/routing";
...
type LoadedConfig = ZuvixConfig;
export type RuntimeEnv = import("zuvix/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("zuvix/plugin-sdk/config-contracts").ZuvixConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
