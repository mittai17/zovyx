...
import type { DiscordAccountConfig } from "zuvix/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "zuvix/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "zuvix/plugin-sdk/proxy-capture";
import { danger, warn } from "zuvix/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("zuvix/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class ZuvixGatewayPlugin extends discordGateway.GatewayPlugin {
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Zuvix registers its own async interaction listener.
