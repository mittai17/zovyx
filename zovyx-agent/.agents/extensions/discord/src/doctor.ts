...
import { collectProviderDangerousNameMatchingScopes } from "zuvix/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: ZuvixConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: ZuvixConfig,
  doctorFixCommand: string,
): { config: ZuvixConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: ZuvixConfig): string[] {
