...
import { buildMessagingTarget, type MessagingTarget } from "zuvix/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "zuvix/plugin-sdk/directory-runtime";
