...
import { buildOutboundMediaLoadOptions } from "zuvix/plugin-sdk/media-runtime";
import { extensionForMime } from "zuvix/plugin-sdk/media-runtime";
import {
...
import { resolveTextChunksWithFallback } from "zuvix/plugin-sdk/reply-payload";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: ZuvixConfig },
): Promise<{ channelId: string; dm?: boolean }> {
