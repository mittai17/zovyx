...
import type { ZuvixConfig, TtsConfig } from "zuvix/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "zuvix/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: ZuvixConfig; override?: TtsConfig }): {
  cfg: ZuvixConfig;
