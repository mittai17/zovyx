...
import type { DiscordAccountConfig, DiscordActionConfig, ZuvixConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: ZuvixConfig): ResolvedDiscordAccount[] {
