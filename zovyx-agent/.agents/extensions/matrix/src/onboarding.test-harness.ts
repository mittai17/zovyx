...
import type { OutputRuntimeEnv } from "zuvix/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "zuvix/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Zuvix Gateway",
    },
    confirm: {
