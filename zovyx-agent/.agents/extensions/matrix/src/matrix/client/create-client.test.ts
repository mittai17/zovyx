...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/zuvix-matrix-create-client-test",
    storagePath: "/tmp/zuvix-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/zuvix-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/zuvix-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/zuvix-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "zuvix-matrix-default-token-hash",
