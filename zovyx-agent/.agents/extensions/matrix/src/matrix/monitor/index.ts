// Matrix plugin entrypoint registers its Zuvix integration.
...
import { resolveOptionalIntegerOption } from "zuvix/plugin-sdk/number-runtime";
import {
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("zuvix/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
