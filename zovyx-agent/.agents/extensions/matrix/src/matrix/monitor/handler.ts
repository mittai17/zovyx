...
import { hasFinalInboundReplyDispatch } from "zuvix/plugin-sdk/channel-inbound";
import type { ChannelBotLoopProtectionFacts } from "zuvix/plugin-sdk/channel-inbound";
import {
...
import { isDangerousNameMatchingEnabled } from "zuvix/plugin-sdk/dangerous-name-runtime";
import {
  isFutureDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "zuvix/plugin-sdk/number-runtime";
import { mergePairLoopGuardConfig } from "zuvix/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "zuvix/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "zuvix/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "zuvix/plugin-sdk/reply-runtime";
...
import { MATRIX_ZUVIX_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("zuvix/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("zuvix/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("zuvix/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("zuvix/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("zuvix/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("zuvix/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_ZUVIX_FINALIZED_PREVIEW_KEY]: true };
}
