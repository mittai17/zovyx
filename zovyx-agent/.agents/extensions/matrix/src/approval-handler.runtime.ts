...
} from "zuvix/plugin-sdk/approval-handler-runtime";
import { createChannelApprovalNativeRuntimeAdapter } from "zuvix/plugin-sdk/approval-handler-runtime";
import { buildChannelApprovalNativeTargetKey } from "zuvix/plugin-sdk/approval-native-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  buildPluginApprovalPendingReplyPayload,
  type ExecApprovalReplyDecision,
} from "zuvix/plugin-sdk/approval-reply-runtime";
import { buildPluginApprovalResolvedReplyPayload } from "zuvix/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "zuvix/plugin-sdk/approval-runtime";
import {
  listMessageReceiptPlatformIds,
  resolveMessageReceiptPrimaryId,
} from "zuvix/plugin-sdk/channel-outbound";
import { normalizeUniqueStringEntries } from "zuvix/plugin-sdk/string-coerce-runtime";
import {
...
// Zuvix Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.zuvix.approval" as const;
