...
import { hasConfiguredSecretInput } from "zuvix/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: ZuvixConfig): Record<string, unknown> | null {
