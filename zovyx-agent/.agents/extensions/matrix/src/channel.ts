...
import type { ChannelOutboundAdapter } from "zuvix/plugin-sdk/channel-send-result";
import { createScopedAccountReplyToModeResolver } from "zuvix/plugin-sdk/conversation-runtime";
import {
