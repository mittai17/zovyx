// Moonshot plugin entrypoint registers its Zuvix integration.
import { defineSingleProviderPluginEntry } from "zuvix/plugin-sdk/provider-entry";
import { buildOpenAICompatibleReplayPolicy } from "zuvix/plugin-sdk/provider-model-shared";
import { MOONSHOT_THINKING_STREAM_HOOKS } from "zuvix/plugin-sdk/provider-stream-family";
