...
vi.mock("zuvix/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("zuvix/plugin-sdk/channel-pairing", () => ({
...
vi.mock("zuvix/plugin-sdk/command-auth-native", () => ({
...
vi.mock("zuvix/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("zuvix/plugin-sdk/reply-history", () => ({
...
vi.mock("zuvix/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("zuvix/plugin-sdk/channel-inbound");
    vi.doUnmock("zuvix/plugin-sdk/channel-pairing");
    vi.doUnmock("zuvix/plugin-sdk/command-auth-native");
    vi.doUnmock("zuvix/plugin-sdk/runtime-group-policy");
    vi.doUnmock("zuvix/plugin-sdk/runtime-env");
    vi.doUnmock("zuvix/plugin-sdk/reply-history");
    vi.doUnmock("zuvix/plugin-sdk/routing");
    vi.doUnmock("zuvix/plugin-sdk/conversation-runtime");
