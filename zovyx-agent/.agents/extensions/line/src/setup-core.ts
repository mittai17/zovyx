...
import type { ChannelSetupAdapter, ZuvixConfig } from "zuvix/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "zuvix/plugin-sdk/setup";
...
export function isLineConfigured(cfg: ZuvixConfig, accountId: string): boolean {
