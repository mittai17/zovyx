...
import type { ZuvixConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function collectRuntimeApiPreExports(runtimeApiPath: string): string[] {
  ...
  const removedLineRuntimeSpecifier = ["zuvix", "plugin-sdk", "line-runtime"].join("/");
...
describe("line setup wizard", () => {
  ...
  it("reports account-scoped config keys for named accounts", () => {
    expect(lineSetupWizard.dmPolicy?.resolveConfigKeys?.({} as ZuvixConfig, "work")).toEqual({
