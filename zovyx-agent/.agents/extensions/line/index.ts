// Line plugin entrypoint registers its Zuvix integration.
import {
...
type RegisteredLineCardCommand = ZuvixPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: ZuvixPluginApi): Promise<RegisteredLineCardCommand> {
