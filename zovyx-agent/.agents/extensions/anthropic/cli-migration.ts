...
type AgentDefaultsModel = NonNullable<NonNullable<ZuvixConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<ZuvixConfig["agents"]>["defaults"]>["models"];
