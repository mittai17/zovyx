...
import {
  ...
  type ZuvixConfig,
} from "zuvix/plugin-sdk/memory-core-host-runtime-core";
import { resolveMemoryBackendConfig } from "zuvix/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  config?: ZuvixConfig;
  getConfig?: () => ZuvixConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): ZuvixConfig | undefined {
...
function resolveMemoryToolOptions(ctx: ZuvixPluginToolContext): MemoryToolOptions {
