...
type Logger = Pick<ZuvixPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__zuvix_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__zuvix_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- zuvix:dreaming:light:start -->",
    endMarker: "<!-- zuvix:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- zuvix:dreaming:rem:start -->",
    endMarker: "<!-- zuvix:dreaming:rem:end -->",
  },
] as const;
