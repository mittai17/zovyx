...
import { createAsyncLock } from "zuvix/plugin-sdk/async-lock-runtime";
import { extractErrorCode } from "zuvix/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "zuvix/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "zuvix/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "zuvix/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- zuvix:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- zuvix:dreaming:deep:end -->";
