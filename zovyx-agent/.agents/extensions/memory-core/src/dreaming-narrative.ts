...
import { resolveStateDir } from "zuvix/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- zuvix:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- zuvix:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "zuvix:dreaming:backfill-entry";
