...
import { listRegisteredMemoryEmbeddingProviderAdapters } from "zuvix/plugin-sdk/memory-core-host-embedding-registry";
import {
...
import { extractKeywords } from "zuvix/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
import { uniqueValues } from "zuvix/plugin-sdk/string-coerce-runtime";
import {
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("zuvix.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: ZuvixConfig;
