...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as ZuvixConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/zuvix-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("ZUVIX_STATE_DIR", path.join(os.tmpdir(), "zuvix-session-sync-yield"));
