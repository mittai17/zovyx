...
export { getChatChannelMeta, type ChannelPlugin } from "zuvix/plugin-sdk/core";
...
export { normalizeE164 } from "zuvix/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "zuvix/plugin-sdk/config-contracts";
import type { ZuvixConfig as RuntimeZuvixConfig } from "zuvix/plugin-sdk/config-contracts";

export { type ChannelMessageActionName } from "zuvix/plugin-sdk/channel-contract";
...
export type ZuvixConfig = RuntimeZuvixConfig;
