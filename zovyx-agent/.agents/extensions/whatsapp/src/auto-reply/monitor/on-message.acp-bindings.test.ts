...
import type { ConfiguredBindingRouteResult } from "zuvix/plugin-sdk/conversation-binding-runtime";
...
vi.mock("zuvix/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("zuvix/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("zuvix/plugin-sdk/routing")>();
  return {
    ...actual,
