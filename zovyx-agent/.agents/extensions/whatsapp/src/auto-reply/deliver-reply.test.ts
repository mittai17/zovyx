...
import { sleep } from "zuvix/plugin-sdk/text-utility-runtime";
...
vi.mock("zuvix/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("zuvix/plugin-sdk/text-utility-runtime")>(
    "zuvix/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
