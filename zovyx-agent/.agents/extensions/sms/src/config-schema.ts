...
} from "zuvix/plugin-sdk/channel-config-primitives";
import { requireChannelOpenAllowFrom } from "zuvix/plugin-sdk/extension-shared";
import { buildSecretInputSchema } from "zuvix/plugin-sdk/secret-input";
import { z } from "zod";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before Zuvix splits long replies.",
    },
  },
});
