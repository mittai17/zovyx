/**
 * Zuvix agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "zuvix/plugin-sdk/core";
...
/** Dependencies needed to build Zuvix agent tools. */
...
/**
 * Creates the Zuvix tools that expose Codex endpoint health and session
 * controls.
 */
export function createCodexSupervisorTools({
  ...
  return [
    ...
    },
    {
      ...
      description: "List Codex sessions visible to the Zuvix supervisor.",
