// Talk Voice plugin entrypoint registers its Zuvix integration.
...
import type { SpeechVoiceOption } from "zuvix/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "zuvix/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "zuvix/plugin-sdk/talk-config-runtime";
  ...
  register(api: ZuvixPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as ZuvixConfig;
