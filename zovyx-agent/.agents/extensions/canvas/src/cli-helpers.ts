...
import { resolvePreferredZuvixTmpDir } from "zuvix/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "zuvix/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredZuvixTmpDir();
  if (!opts.tmpDir) {
