 ...
 */
import { lowercasePreservingWhitespace } from "zuvix/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__zuvix__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__zuvix__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__zuvix__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.zuvixCanvasA2UIAction.postMessage(...)
  // - Android: window.zuvixCanvasA2UIAction.postMessage(...)
  const handlerNames = ["zuvixCanvasA2UIAction"];
  ...
  globalThis.Zuvix = globalThis.Zuvix ?? {};
  globalThis.Zuvix.postMessage = postToNode;
  globalThis.Zuvix.sendUserAction = sendUserAction;
  globalThis.zuvixPostMessage = postToNode;
  globalThis.zuvixSendUserAction = sendUserAction;
