...
import type { ChannelRuntimeSurface } from "zuvix/plugin-sdk/channel-contract";
...
import type { SignalReactionNotificationMode } from "zuvix/plugin-sdk/config-contracts";
import {
  detectMime,
...
import type { ReplyPayload } from "zuvix/plugin-sdk/reply-runtime";
import {
  chunkTextWithMode,
  resolveChunkMode,
