...
import { createLazyChannelApprovalNativeRuntimeAdapter } from "zuvix/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelApprovalNativeRuntimeAdapter } from "zuvix/plugin-sdk/approval-handler-runtime";
import {
...
import { buildApprovalReactionPendingContentForRequest } from "zuvix/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
...
import { parseAgentSessionKey } from "zuvix/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<ZuvixConfig["approvals"]>["exec"]>;
