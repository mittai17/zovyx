...
import { createChannelPluginBase, getChatChannelMeta } from "zuvix/plugin-sdk/core";
import type { ChannelPlugin } from "zuvix/plugin-sdk/core";
import { normalizeStringifiedEntries } from "zuvix/plugin-sdk/string-coerce-runtime";
