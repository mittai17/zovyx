...
function resolveQianfanPreset(cfg: ZuvixConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: ZuvixConfig): ZuvixConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: ZuvixConfig): ZuvixConfig {
