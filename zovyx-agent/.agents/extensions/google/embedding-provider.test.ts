...
vi.mock("zuvix/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("zuvix/plugin-sdk/memory-core-host-engine-embeddings")>();
  return {
    ...actual,
