...
import { createProviderHttpError } from "zuvix/plugin-sdk/provider-http";
import {
...
} from "zuvix/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "zuvix-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "ZUVIX_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "zuvix-google-generative-ai-transport":
