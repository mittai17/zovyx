...
import { buildOauthProviderAuthResult } from "zuvix/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "zuvix/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "zuvix/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: ZuvixPluginApi) {
