...
export { mutateConfigFile, replaceConfigFile } from "zuvix/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "zuvix/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "zuvix/plugin-sdk/text-utility-runtime";
