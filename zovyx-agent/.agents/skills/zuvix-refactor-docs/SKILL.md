---
name: zuvix-refactor-docs
description: Refactor an existing Zuvix docs page with source-audited preservation, restructuring, and verification.
---
...
Use this skill when the user gives a target Zuvix docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `zuvix-docs`: use that skill for style, page types,
...
Read `../zuvix-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `zuvix-docs`.
