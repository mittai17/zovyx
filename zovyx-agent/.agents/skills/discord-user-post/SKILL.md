...
description: Post an approved message as the logged-in Discord user through the Discord desktop app. Use for release announcements or other direct user-authored Discord posts; not for Zuvix channel sends, bots, webhooks, relays, agent sessions, or archive search.
---
...
- Never use `zuvix message`, an Zuvix agent, a Discord bot, webhook, relay,
