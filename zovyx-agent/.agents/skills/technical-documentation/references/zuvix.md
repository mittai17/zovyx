# Zuvix Documentation Overlay

Use this reference only for Zuvix docs work. It layers Zuvix-specific page
...
- Topic page: explain a major Zuvix entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Zuvix repo behavior.
