...
- For Zuvix docs work, choose a page type from `references/zuvix.md` before drafting.
- Keep task-critical Zuvix configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Zuvix docs work, apply the validation checklist in `references/zuvix.md`.
