...
- Applying repository-specific documentation overlays, including Zuvix page-type, docs IA, preservation, and validation rules when present.
...
6. For Zuvix docs work, read `references/zuvix.md` before the build/review playbook.
