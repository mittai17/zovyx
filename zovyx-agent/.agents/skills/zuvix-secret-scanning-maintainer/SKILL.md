---
name: zuvix-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Zuvix GitHub Secret Scanning alerts in issues or PRs.
---

# Zuvix Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/zuvix/zuvix/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/zuvix-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/zuvix/zuvix/issues/63101#issuecomment-xxx",
