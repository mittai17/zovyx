---
name: zuvix-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm Zuvix GHSA security advisories and private-fork state."
---

# Zuvix GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-zuvix-maintainer`.
...
```bash
fork=$(gh api /repos/zuvix/zuvix/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/zuvix/zuvix/security-advisories/<GHSA> \
