...
const (
	...
	envDocsI18nProvider      = "ZUVIX_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "ZUVIX_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<zuvix_docs_i18n_input>", "</zuvix_docs_i18n_input>"} {
