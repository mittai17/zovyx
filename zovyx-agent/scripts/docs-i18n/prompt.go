...
- Keep product names in English: Zuvix, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Zuvix Gateway, use “Gateway 网关”.
