...
// Summarizes Zuvix performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/zuvix-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Zuvix-native performance probe artifacts for CI reports.`);
}
