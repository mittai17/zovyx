...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("ZUVIX_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 308),
    publicExports: readBudgetEnv("ZUVIX_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 9920),
    publicFunctionExports: readBudgetEnv("ZUVIX_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5031),
    publicDeprecatedExports: readBudgetEnv(
      "ZUVIX_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3143,
    ),
    publicWildcardReexports: readBudgetEnv(
      "ZUVIX_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      215,
    ),
  };
} catch (error) {
