...
show_usage() {
    cat << EOF
clawlog - Zuvix Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Zuvix logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Zuvix logs flow through the macOS unified log (subsystem: ai.zuvix).
