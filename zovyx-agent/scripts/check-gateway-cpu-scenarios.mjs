  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          ZUVIX_HOME: qaState.home,
          ZUVIX_STATE_DIR: qaState.stateDir,
          ZUVIX_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    ZUVIX_BUILD_PRIVATE_QA: "1",
    ZUVIX_ENABLE_PRIVATE_QA_CLI: "1",
    ZUVIX_RUN_NODE_SKIP_DTS_BUILD: env.ZUVIX_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    ZUVIX_TEST_DISABLE_UPDATE_CHECK: env.ZUVIX_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}
