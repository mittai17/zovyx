...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "zuvix-clawsweeper[bot]"]);
...
const liveCommandRegex =
  /\b(?:zuvix|node|docker|curl|gh|ssh|adb|xcrun|xcodebuild|open|npm\s+run|pnpm\s+zuvix)\b/i;
