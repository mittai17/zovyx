...
function ensureZuvixExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "zuvix");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "zuvix.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureZuvixExtensionAlias({ repoRoot, distExtensionsRoot });
