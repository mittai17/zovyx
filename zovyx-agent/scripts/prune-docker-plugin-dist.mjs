...
/**
 * Parses ZUVIX_EXTENSIONS into the bundled plugin ids that Docker should keep.
 */
...
export function pruneDockerPluginDist(params = {}) {
  ...
  const bundledPluginDir = env.ZUVIX_BUNDLED_PLUGIN_DIR ?? "extensions";
  const keepPluginIds = parseDockerPluginKeepList(env.ZUVIX_EXTENSIONS);
