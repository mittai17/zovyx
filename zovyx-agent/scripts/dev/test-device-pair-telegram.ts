// Test Device Pair Telegram script supports Zuvix repository automation.
...
import { loadZuvixPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadZuvixPlugins: typeof loadZuvixPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadZuvixPlugins({ config: cfg });
