// Control Ui I18N script supports Zuvix repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "zuvix/plugin-sdk/llm";
...
const ENV_PROVIDER = "ZUVIX_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "ZUVIX_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "ZUVIX_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "ZUVIX_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "ZUVIX_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "ZUVIX_CONTROL_UI_I18N_AUTH_OPTIONAL";
