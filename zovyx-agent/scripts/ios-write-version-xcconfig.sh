...
- ZUVIX_IOS_VERSION = exact canonical iOS version
- ZUVIX_MARKETING_VERSION = short iOS/App Store version
- ZUVIX_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ZUVIX_IOS_VERSION = ${IOS_VERSION}
ZUVIX_MARKETING_VERSION = ${MARKETING_VERSION}
ZUVIX_BUILD_VERSION = ${BUILD_NUMBER}
EOF
