// Check No Deprecated Channel Access script supports Zuvix repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']zuvix\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']zuvix\/plugin-sdk\/command-auth["']/u,
  },
  {
