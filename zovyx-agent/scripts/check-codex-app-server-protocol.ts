// Check Codex App Server Protocol script supports Zuvix repository automation.
...
async function main(): Promise<void> {
  ...
  console.log(
    `Codex app-server generated protocol matches Zuvix bridge assumptions: ${source.codexRepo}`,
  );
}
