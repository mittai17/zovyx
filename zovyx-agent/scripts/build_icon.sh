...
# Defaults target the Zuvix assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Zuvix/Resources/Zuvix.icns"}
