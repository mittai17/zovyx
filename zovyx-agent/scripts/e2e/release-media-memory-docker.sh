...
IMAGE_NAME="$(docker_e2e_resolve_image "zuvix-release-media-memory-e2e" ZUVIX_RELEASE_MEDIA_MEMORY_E2E_IMAGE)"
SKIP_BUILD="${ZUVIX_RELEASE_MEDIA_MEMORY_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-media-memory "${ZUVIX_CURRENT_PACKAGE_TGZ:-}")"
...
ZUVIX_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-media-memory empty)"
