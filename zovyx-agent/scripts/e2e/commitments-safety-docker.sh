...
IMAGE_NAME="$(docker_e2e_resolve_image "zuvix-commitments-safety-e2e" ZUVIX_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="zuvix-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t zuvix-commitments-safety-log.XXXXXX)"
