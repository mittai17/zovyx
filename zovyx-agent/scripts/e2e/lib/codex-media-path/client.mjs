...
const appServerLog =
  process.env.ZUVIX_CODEX_MEDIA_PATH_APP_SERVER_LOG ??
  "/tmp/zuvix-codex-media-path-app-server.jsonl";
const timeoutSeconds = readPositiveIntEnv("ZUVIX_CODEX_MEDIA_PATH_TIMEOUT_SECONDS", 180);
const logTailMaxBytes = readPositiveIntEnv(
  "ZUVIX_CODEX_MEDIA_PATH_LOG_TAIL_MAX_BYTES",
  2 * 1024 * 1024,
);
