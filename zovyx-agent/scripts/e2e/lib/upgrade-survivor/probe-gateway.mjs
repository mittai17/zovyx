...
const allowDegradedReady =
  ...
  process.env.ZUVIX_UPGRADE_SURVIVOR_READYZ_ALLOW_DEGRADED === "1";
const timeoutOption = optionValue(
  "--timeout-ms",
  "ZUVIX_UPGRADE_SURVIVOR_PROBE_TIMEOUT_MS",
  "60000",
);
const attemptTimeoutOption = optionValue(
  "--attempt-timeout-ms",
  "ZUVIX_UPGRADE_SURVIVOR_PROBE_ATTEMPT_TIMEOUT_MS",
  "5000",
);
const maxBodyOption = optionValue(
  "--max-body-bytes",
  "ZUVIX_UPGRADE_SURVIVOR_PROBE_MAX_BODY_BYTES",
  "1048576",
);
