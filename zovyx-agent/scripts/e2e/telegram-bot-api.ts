// Telegram Bot Api script supports Zuvix repository automation.
...
const DEFAULT_BASE_URL =
  process.env.ZUVIX_TELEGRAM_USER_BOT_API_BASE_URL ?? "https://api.telegram.org";
...
export function readTelegramBotApiLimits(
  ...
  return {
    bodyMaxBytes: readPositiveIntEnv(
      "ZUVIX_TELEGRAM_USER_BOT_API_BODY_MAX_BYTES",
      1024 * 1024,
      env,
    ),
    timeoutMs: readPositiveIntEnv("ZUVIX_TELEGRAM_USER_BOT_API_TIMEOUT_MS", 30000, env),
  };
}
