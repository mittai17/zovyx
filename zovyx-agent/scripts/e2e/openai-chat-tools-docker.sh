...
IMAGE_NAME="$(docker_e2e_resolve_image "zuvix-openai-chat-tools-e2e" ZUVIX_OPENAI_CHAT_TOOLS_E2E_IMAGE)"
SKIP_BUILD="${ZUVIX_OPENAI_CHAT_TOOLS_E2E_SKIP_BUILD:-0}"
PORT="${ZUVIX_OPENAI_CHAT_TOOLS_PORT:-18789}"
TOKEN="openai-chat-tools-e2e-$$"
PROFILE_FILE="${ZUVIX_OPENAI_CHAT_TOOLS_PROFILE_FILE:-${ZUVIX_TESTBOX_PROFILE_FILE:-$HOME/.zuvix-testbox-live.profile}}"
...
ZUVIX_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-chat-tools empty)"
...
docker_e2e_run_logged_with_harness openai-chat-tools \
  ...
  -e "ZUVIX_OPENAI_CHAT_TOOLS_MODEL=${ZUVIX_OPENAI_CHAT_TOOLS_MODEL:-openai/gpt-5.4-mini}" \
  -e "ZUVIX_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS=${ZUVIX_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS:-180}" \
