...
IMAGE_NAME="$(docker_e2e_resolve_image "zuvix-release-plugin-marketplace-e2e" ZUVIX_RELEASE_PLUGIN_MARKETPLACE_E2E_IMAGE)"
SKIP_BUILD="${ZUVIX_RELEASE_PLUGIN_MARKETPLACE_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-plugin-marketplace "${ZUVIX_CURRENT_PACKAGE_TGZ:-}")"
...
ZUVIX_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-plugin-marketplace empty)"
