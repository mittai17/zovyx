// Macos Discord script supports Zuvix repository automation.
...
${this.input.guestNode} ${this.input.guestZuvixEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestZuvixEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestZuvixEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestZuvixEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestZuvixEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestZuvixEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestZuvixEntry} gateway restart
${this.input.guestNode} ${this.input.guestZuvixEntry} channels status --probe --json`);
  }
