...
IMAGE_NAME="$(docker_e2e_resolve_image "zuvix-session-runtime-context-e2e" ZUVIX_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="zuvix-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t zuvix-session-runtime-context-log.XXXXXX)"
