...
// Test Live Media script supports Zuvix repository automation.
...
export const MEDIA_SUITES: Record<MediaSuiteId, MediaSuiteConfig> = {
  image: {
    ...
    providerEnvVar: "ZUVIX_LIVE_IMAGE_GENERATION_PROVIDERS",
  ...
  music: {
    ...
    providerEnvVar: "ZUVIX_LIVE_MUSIC_GENERATION_PROVIDERS",
    providers: ["fal", "google", "minimax", "openrouter"],
  },
  video: {
    id: "video",
    testFile: "extensions/video-generation-providers.live.test.ts",
    providerEnvVar: "ZUVIX_LIVE_VIDEO_GENERATION_PROVIDERS",
    providers: [
      "alibaba",
      "byteplus",
      "deepinfra",
