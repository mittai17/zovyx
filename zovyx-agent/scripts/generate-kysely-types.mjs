...
const SCHEMAS = [
  {
    name: "zuvix-state",
    schema: "src/state/zuvix-state-schema.sql",
    outFile: "src/state/zuvix-state-db.generated.d.ts",
    schemaOutFile: "src/state/zuvix-state-schema.generated.ts",
    schemaExport: "ZUVIX_STATE_SCHEMA_SQL",
  },
  {
    name: "zuvix-agent",
    schema: "src/state/zuvix-agent-schema.sql",
    outFile: "src/state/zuvix-agent-db.generated.d.ts",
    schemaOutFile: "src/state/zuvix-agent-schema.generated.ts",
    schemaExport: "ZUVIX_AGENT_SCHEMA_SQL",
  },
];
