# Zuvix — Cloud-Synced AI Workspace

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/zuvix-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/zuvix-logo-text.svg" alt="Zuvix" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/zuvix/zuvix/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/zuvix/zuvix/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/zuvix/zuvix/releases"><img src="https://img.shields.io/github/v/release/zuvix/zuvix?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Zuvix** is a cloud-synced AI workspace you can run across web, desktop, and mobile clients.
It answers you on the channels you already use, syncs account data through the configured cloud backend, and keeps platform-specific device features in native apps where they belong. The Gateway is the control plane; the clients are Windows/Linux web apps plus native macOS, iOS, and Android apps.

If you want one assistant workspace that follows you across Windows, Linux, macOS, iOS, and Android, this is it.

Supported channels include: WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat.

[Platform sync guide](docs/platforms/zuvix-sync.md) · [Vision](VISION.md) · [Third-party notices](THIRD_PARTY_NOTICES.md)

New install? Start here: [Getting started](https://docs.zuvix.ai/start/getting-started)

Preferred setup: run `zuvix onboard` in your terminal.
Zuvix Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows**.
Windows desktop users can start with the native [Windows Hub](https://docs.zuvix.ai/platforms/windows) companion app for setup, tray status, chat, node mode, and local MCP mode.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/zuvix/zuvix/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.zuvix.ai/start/wizard).
...
```bash
npm install -g zuvix@latest
# or: pnpm add -g zuvix@latest

zuvix onboard --install-daemon
```

Zuvix Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.zuvix.ai/start/getting-started)
...
```bash
zuvix gateway stop
zuvix gateway --port 18789 --verbose
```
...
```bash
# Send a message
zuvix message send --target +1234567890 --message "Hello from Zuvix"
...
zuvix agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.zuvix.ai/install/updating) (and run `zuvix doctor`).

Models config + CLI: [Models](https://docs.zuvix.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.zuvix.ai/concepts/model-failover).

## Security defaults (DM access)

Zuvix connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.zuvix.ai/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.zuvix.ai/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `zuvix pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `zuvix doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.zuvix.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.zuvix.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.zuvix.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.zuvix.ai/nodes/voicewake) + [Talk Mode](https://docs.zuvix.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.zuvix.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.zuvix.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.zuvix.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.zuvix.ai/platforms)** — Windows Hub, macOS menu bar app, and iOS/Android [nodes](https://docs.zuvix.ai/nodes).
- **[Onboarding](https://docs.zuvix.ai/start/wizard) + [skills](https://docs.zuvix.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.zuvix.ai/gateway/security), [Gateway exposure runbook](https://docs.zuvix.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.zuvix.ai/gateway/sandboxing), and [Configuration](https://docs.zuvix.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.zuvix.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.zuvix.ai/start/getting-started), [Onboarding](https://docs.zuvix.ai/start/wizard), [Updating](https://docs.zuvix.ai/install/updating)
- Channel setup: [Channels index](https://docs.zuvix.ai/channels), [WhatsApp](https://docs.zuvix.ai/channels/whatsapp), [Telegram](https://docs.zuvix.ai/channels/telegram), [Discord](https://docs.zuvix.ai/channels/discord), [Slack](https://docs.zuvix.ai/channels/slack)
- Apps + nodes: [Windows Hub](https://docs.zuvix.ai/platforms/windows), [macOS](https://docs.zuvix.ai/platforms/macos), [iOS](https://docs.zuvix.ai/platforms/ios), [Android](https://docs.zuvix.ai/platforms/android), [Nodes](https://docs.zuvix.ai/nodes)
- Config + security: [Configuration](https://docs.zuvix.ai/gateway/configuration), [Security](https://docs.zuvix.ai/gateway/security), [Exposure runbook](https://docs.zuvix.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.zuvix.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.zuvix.ai/gateway), [Remote access](https://docs.zuvix.ai/gateway/remote), [Tailscale](https://docs.zuvix.ai/gateway/tailscale), [Web surfaces](https://docs.zuvix.ai/web)
- Tools + automation: [Tools](https://docs.zuvix.ai/tools), [Skills](https://docs.zuvix.ai/tools/skills), [Cron jobs](https://docs.zuvix.ai/automation/cron-jobs), [Webhooks](https://docs.zuvix.ai/automation/webhook), [Gmail Pub/Sub](https://docs.zuvix.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.zuvix.ai/concepts/architecture), [Agent](https://docs.zuvix.ai/concepts/agent), [Session model](https://docs.zuvix.ai/concepts/session), [Gateway protocol](https://docs.zuvix.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.zuvix.ai/channels/troubleshooting), [Logging](https://docs.zuvix.ai/logging), [Docs home](https://docs.zuvix.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.zuvix.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `zuvix nodes …`.

Runbook: [iOS connect](https://docs.zuvix.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`zuvix devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.zuvix.ai/platforms/android).
...
```bash
git clone https://github.com/zuvix/zuvix.git
cd zuvix
...
`pnpm zuvix setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm zuvix onboard --install-daemon`.

Note: `pnpm zuvix ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `zuvix` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `zuvix update --channel stable|beta|dev`.
Details: [Development channels](https://docs.zuvix.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.zuvix/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.zuvix/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.zuvix/zuvix.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.zuvix.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=zuvix/zuvix&type=date&legend=top-left)](https://www.star-history.com/#zuvix/zuvix&type=date&legend=top-left)

## Molty

Zuvix was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [zuvix.ai](https://zuvix.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@zuvix](https://x.com/zuvix)
