...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "ZUVIX_OAUTH_DIR",
  "ZUVIX_PINNED_PYTHON",
  "ZUVIX_PINNED_WRITE_PYTHON",
  "ZUVIX_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Zuvix runtime namespace
  // for shell/global config so new ZUVIX_* controls are fail-closed by default.
  "ZUVIX_",
  "ZUVIX_CLAWHUB_",
  "ZUVIX_DISABLE_",
  "ZUVIX_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.zuvix/.env (or ZUVIX_STATE_DIR/.env),
