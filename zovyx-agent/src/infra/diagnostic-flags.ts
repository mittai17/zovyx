...
import { normalizeUniqueStringEntriesLower } from "@zuvix/normalization-core/string-normalization";
import type { ZuvixConfig } from "../config/types.zuvix.js";

const DIAGNOSTICS_ENV = "ZUVIX_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `ZUVIX_DIAGNOSTICS` overrides. */
