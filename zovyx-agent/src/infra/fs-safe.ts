// Re-exports fs-safe helpers with Zuvix defaults and wrappers.
...
import { root as fsSafeRoot, type ReadResult } from "@zuvix/fs-safe/root";

export { FsSafeError, type FsSafeErrorCode } from "@zuvix/fs-safe/errors";
export {
...
export { isPathInside } from "@zuvix/fs-safe/path";
export { pathExists, pathExistsSync } from "@zuvix/fs-safe/advanced";
export { movePathToTrash, type MovePathToTrashOptions } from "@zuvix/fs-safe/advanced";
export { readLocalFileFromRoots, resolveLocalPathFromRootsSync } from "@zuvix/fs-safe/advanced";
export {
  appendRegularFile,
...
export {
  ...
  type ReadResult,
  type Root,
} from "@zuvix/fs-safe/root";
export { sanitizeUntrustedFileName } from "@zuvix/fs-safe/advanced";
export {
  readSecureFile,
  type SecureFileReadOptions,
  type SecureFileReadResult,
} from "@zuvix/fs-safe/secure-file";
export {
  walkDirectory,
  walkDirectorySync,
...
} from "@zuvix/fs-safe/walk";
export { withTimeout } from "@zuvix/fs-safe/advanced";
