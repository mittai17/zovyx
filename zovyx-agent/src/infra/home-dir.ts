// Resolves Zuvix home and platform-specific config directories.
...
/** Resolves Zuvix's effective home, honoring ZUVIX_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring ZUVIX_HOME overrides. */
...
/** Resolves a user-supplied path against the OS home, ignoring ZUVIX_HOME. */
