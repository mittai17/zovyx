...
import { readSecretFileSync as readSecretFileSyncImpl } from "@zuvix/fs-safe/secret";
...
} from "@zuvix/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@zuvix/fs-safe/secret";
