...
// adding Zuvix NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - Zuvix extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see zuvix#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
