// Wraps fs-safe JSON reads and atomic writes with Zuvix defaults.
import "./fs-safe-defaults.js";
import {
  JsonFileReadError,
  readJson as readJsonImpl,
  readJsonIfExists as readJsonIfExistsImpl,
} from "@zuvix/fs-safe/json";
 ...
 * tryReadJsonImpl from @zuvix/fs-safe. The fs-safe implementation retries
...
export { createAsyncLock } from "@zuvix/fs-safe/advanced";
