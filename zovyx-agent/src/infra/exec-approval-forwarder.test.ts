...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): ZuvixConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): ZuvixConfig {
  return {
