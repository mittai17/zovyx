// Wraps fs-safe atomic replacement and move helpers for Zuvix install flows.
...
/**
 * Moves a path using fs-safe's copy fallback, with an Zuvix hardlink guard
