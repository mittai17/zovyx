...
const DEFAULT_VAPID_SUBJECT = "https://zuvix.ai";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.ZUVIX_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.ZUVIX_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.ZUVIX_VAPID_PRIVATE_KEY || undefined;
}
