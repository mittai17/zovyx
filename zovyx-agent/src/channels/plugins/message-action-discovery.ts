 ...
 */
export function listChannelMessageActions(cfg: ZuvixConfig): ChannelMessageActionName[] {
 ...
 */
export function listChannelMessageCapabilities(cfg: ZuvixConfig): ChannelMessageCapability[] {
