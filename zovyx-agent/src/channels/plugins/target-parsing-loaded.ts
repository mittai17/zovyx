...
/** @deprecated Use `channelRouteTargetsMatchExact` from `zuvix/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `zuvix/plugin-sdk/channel-route`. */
