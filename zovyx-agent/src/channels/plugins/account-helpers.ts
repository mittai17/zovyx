...
export function createAccountListHelpers(
  ...
  options?: {
    ...
    hasImplicitDefaultAccount?: (cfg: ZuvixConfig) => boolean;
  },
) {
  function hasImplicitDefaultAccount(cfg: ZuvixConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: ZuvixConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listAccountIds(cfg: ZuvixConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: ZuvixConfig): string {
