...
export type ChannelMessageSendTextContext<TConfig = ZuvixConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = ZuvixConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = ZuvixConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = ZuvixConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = ZuvixConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = ZuvixConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = ZuvixConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
