/** Summarizes installed service command paths and Zuvix package layout. */
...
async function resolveZuvixPackageRoot(entrypoint: string): Promise<string | undefined> {
...
export async function summarizeGatewayServiceLayout(
  ...
  const packageRoot = entrypointReal ? await resolveZuvixPackageRoot(entrypointReal) : undefined;
