...
function hasConfiguredAuthProfiles(cfg: ZuvixConfig): boolean {
  return (
...
function resolveCronActiveRuntimeConfig(cfg: ZuvixConfig): ZuvixConfig {
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: ZuvixConfig = {
    ...runtimeCfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ZUVIX_TEST_FAST === "1";
