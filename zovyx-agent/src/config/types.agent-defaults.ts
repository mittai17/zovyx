...
export type AgentDefaultsConfig = {
  ...
  /** Embedded Zuvix runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded Zuvix should trust workspace-local `.zuvix/settings.json`.
    ...
    /**
     * Embedded Zuvix execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded Zuvix reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded Zuvix keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded Zuvix compaction (0 disables the floor). */
