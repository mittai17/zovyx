...
function expectZuvixSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = ZuvixSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectZuvixSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = ZuvixSchema.safeParse(config);
