...
export type WideAreaDiscoveryConfig = {
  ...
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "zuvix.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/zuvix"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__zuvix__/canvas or /__zuvix__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
  ...
  resetOnExit?: boolean;
  /** Optional Tailscale Service name, such as `svc:zuvix`, for Serve mode. */
  serviceName?: string;
  /**
   ...
   * startup. Lets operators manage Funnel exposure outside Zuvix without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/zuvix/zuvix/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var ZUVIX_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
