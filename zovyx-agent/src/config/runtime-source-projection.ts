...
function isCompatibleTopLevelRuntimeProjectionShape(params: {
  runtimeSnapshot: ZuvixConfig;
  candidate: ZuvixConfig;
}): boolean {
...
export function projectConfigOntoRuntimeSourceSnapshot(config: ZuvixConfig): ZuvixConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as ZuvixConfig;
}
