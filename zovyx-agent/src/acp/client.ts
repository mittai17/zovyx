/** Interactive stdio ACP client used to connect a terminal session to an Zuvix ACP server. */
...
async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "zuvix";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "zuvix-acp-client", version: "1.0.0" },
  });
