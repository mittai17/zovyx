...
import type {
  ...
  AcpRuntimeHandle,
  AcpRuntimeStatus,
} from "@zuvix/acp-core/runtime/types";
...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ZuvixConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ZuvixConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: ZuvixConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: ZuvixConfig): Promise<void> {
