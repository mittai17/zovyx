...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@zuvix/acp-core/runtime/types";
...
export type { AcpRuntime, ZuvixConfig, SessionAcpMeta };
...
export const ORIGINAL_STATE_DIR = process.env.ZUVIX_STATE_DIR;
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      deleteTestEnvValue("ZUVIX_STATE_DIR");
    } else {
      setTestEnvValue("ZUVIX_STATE_DIR", ORIGINAL_STATE_DIR);
    }
