...
type AcpSessionsTable = ZuvixStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<ZuvixStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: ZuvixConfig; storePath: string } {
...
function selectAcpSessionRows(options: ZuvixStateDatabaseOptions = {}): AcpSessionRow[] {
