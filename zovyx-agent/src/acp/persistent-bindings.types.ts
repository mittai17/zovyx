...
import { normalizeText } from "@zuvix/acp-core/normalize-text";
...
export { normalizeText } from "@zuvix/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning Zuvix agent id (used for session identity/storage). */
  agentId: string;
