    ...
    info: {
      ...
      hostRequirements: {
        "agent-run": {
          ...
          unsupportedMessage:
            "Use the native Codex or Zuvix embedded runtime, or switch contextEngine to legacy.",
        },
      },
    },
    async ingest() {
...
describe("context engine host compatibility", () => {
  ...
  it("allows native Codex and Zuvix embedded hosts to satisfy pre-prompt assembly", () => {
