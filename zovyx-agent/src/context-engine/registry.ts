...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("zuvix.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("zuvix.contextEngineRegistryState");
