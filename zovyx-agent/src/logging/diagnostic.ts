...
function resolveDiagnosticSessionStorePaths(config?: ZuvixConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: ZuvixConfig): boolean {
...
export function isStuckSessionRecoveryEnabled(config?: ZuvixConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: ZuvixConfig): number {
