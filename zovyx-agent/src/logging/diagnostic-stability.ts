...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __zuvixDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__zuvixDiagnosticStabilityState"] ??= createState();
  return globalStore["__zuvixDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__zuvixDiagnosticStabilityState"] = next;
}
