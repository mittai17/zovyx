...
type ConsoleConfigLoader = () => ZuvixConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.ZUVIX_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.ZUVIX_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
  ...
  let cfg: ZuvixConfig["logging"] | undefined =
