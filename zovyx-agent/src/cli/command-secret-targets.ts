...
function resolveFetchConfig(config: ZuvixConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: ZuvixConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: ZuvixConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: ZuvixConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "zuvix.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: ZuvixConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: ZuvixConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
