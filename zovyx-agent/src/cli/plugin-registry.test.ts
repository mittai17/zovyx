...
function expectLoadZuvixPluginsCall(
  callIndex: number,
  expected: {
    config?: unknown;
  ...
  const params = mocks.loadZuvixPlugins.mock.calls[callIndex]?.[0] as
    | {
        config?: unknown;
        activationSourceConfig?: unknown;
        autoEnabledReasons?: unknown;
...
const mocks = vi.hoisted(() => ({
  loadZuvixPlugins: vi.fn<typeof import("../plugins/loader.js").loadZuvixPlugins>(),
