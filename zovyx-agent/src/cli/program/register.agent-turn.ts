...
/** Register `zuvix agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['zuvix agent --to +15555550123 --message "status update"', "Start a new session."],
  ['zuvix agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['zuvix agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.zuvix.ai/cli/agent")}`,
    )
