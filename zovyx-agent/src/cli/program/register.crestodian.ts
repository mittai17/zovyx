    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["zuvix", "Start Crestodian."],
          ["zuvix crestodian", "Start Crestodian explicitly."],
          ['zuvix crestodian -m "status"', "Run one status request."],
          [
            'zuvix crestodian -m "set default model openai/gpt-5.2" --yes',
