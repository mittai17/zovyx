...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
  ...
  {
    name: "gateway",
    description: "Run, inspect, and query the Zuvix Gateway",
    hasSubcommands: true,
  },
  {
    name: "daemon",
  ...
  {
    name: "docs",
    description: "Search the live Zuvix docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the Zuvix debug proxy and inspect captured traffic",
    hasSubcommands: true,
  },
  {
    name: "hooks",
