      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["zuvix gateway run", "Run the gateway in the foreground."],
            ["zuvix gateway status", "Show service status plus connectivity/capability."],
            ["zuvix gateway discover", "Find local and wide-area gateway beacons."],
            ["zuvix gateway stability", "Show recent stability diagnostics."],
            ["zuvix gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.zuvix.ai/cli/gateway")}\n`,
      ),
  );
