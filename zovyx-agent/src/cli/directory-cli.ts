    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["zuvix directory self --channel slack", "Show the connected account identity."],
          [
            'zuvix directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["zuvix directory groups list --channel discord", "List available groups/channels."],
          [
            "zuvix directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.zuvix.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
