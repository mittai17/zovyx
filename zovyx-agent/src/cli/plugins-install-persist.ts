...
function addInstalledPluginToAllowlist(cfg: ZuvixConfig, pluginId: string): ZuvixConfig {
...
function removeInstalledPluginFromDenylist(cfg: ZuvixConfig, pluginId: string): ZuvixConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `zuvix plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
