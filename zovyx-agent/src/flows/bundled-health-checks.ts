...
import { asOptionalObjectRecord as readRecord } from "@zuvix/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: ZuvixConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: ZuvixConfig; cwd?: string }): boolean {
