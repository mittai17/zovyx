...
export type PromptDefaultModelResult = { model?: string; config?: ZuvixConfig };
...
function resolveConfiguredModelRaw(cfg: ZuvixConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: ZuvixConfig): string[] {
