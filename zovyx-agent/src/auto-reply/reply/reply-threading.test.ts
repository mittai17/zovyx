...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as ZuvixConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as ZuvixConfig, "whatsapp", "default", "group")).toBe("all");
  });
