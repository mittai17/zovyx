...
import type { AcpSessionUpdateTag } from "@zuvix/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: ZuvixConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ZuvixConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ZuvixConfig): AcpProjectionSettings {
