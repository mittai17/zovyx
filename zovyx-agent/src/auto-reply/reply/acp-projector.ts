// Projects ACP runtime events into Zuvix-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@zuvix/acp-core/runtime/types";
import {
