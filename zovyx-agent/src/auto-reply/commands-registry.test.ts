...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@zuvix", { botUsername: "zuvix" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@zuvix args", {
        botUsername: "zuvix",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "zuvix" })).toBe(
      "/help@otherbot",
    );
  });
