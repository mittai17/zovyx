...
import { normalizeOptionalString as readString } from "@zuvix/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "zuvixHeartbeatResponse";
