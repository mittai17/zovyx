...
import { normalizeOptionalString as asString } from "@zuvix/normalization-core/string-coerce";
...
export function buildCommitmentExtractionPrompt(params: {
  ...
  return `You are Zuvix's internal commitment extractor. This is a hidden background classification run. Do not address the user.
