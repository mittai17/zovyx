...
/** Normalized model metadata used by Zuvix provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in Zuvix config and provider catalogs. */
...
/** Map one raw LM Studio model entry into Zuvix model metadata. */
...
/** Discover Zuvix model definitions from an LM Studio server. */
