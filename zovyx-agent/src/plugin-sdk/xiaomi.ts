...
type FacadeModule = {
  applyXiaomiConfig: (cfg: ZuvixConfig) => ZuvixConfig;
  applyXiaomiProviderConfig: (cfg: ZuvixConfig) => ZuvixConfig;
...
/** Apply Xiaomi provider defaults to the full Zuvix config. */
