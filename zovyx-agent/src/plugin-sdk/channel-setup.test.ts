...
import { runSetupWizardFinalize } from "zuvix/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @zuvix/example to be installed. Docs: https://docs.zuvix.ai/channels/example",
    );
