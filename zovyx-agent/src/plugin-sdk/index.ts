...
/** @deprecated Use ZuvixConfig instead */
export type { ZuvixConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use ZuvixConfig instead */
export type { ZuvixConfig as ZuvixSchemaType } from "../config/config.js";
export type {
