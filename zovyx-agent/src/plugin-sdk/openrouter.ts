...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: ZuvixConfig) => ZuvixConfig;
  applyOpenrouterProviderConfig: (cfg: ZuvixConfig) => ZuvixConfig;
...
/** Apply OpenRouter defaults to the full Zuvix config. */
