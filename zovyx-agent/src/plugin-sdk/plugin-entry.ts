...
export type ZuvixPluginApi = import("../plugins/types.js").ZuvixPluginApi;
export type ZuvixPluginCommandDefinition =
  import("../plugins/types.js").ZuvixPluginCommandDefinition;
export type ZuvixPluginConfigSchema = import("../plugins/types.js").ZuvixPluginConfigSchema;
export type ZuvixPluginDefinition = import("../plugins/types.js").ZuvixPluginDefinition;
export type ZuvixPluginHttpRouteHandler =
  import("../plugins/types.js").ZuvixPluginHttpRouteHandler;
export type ZuvixPluginNodeHostCommand =
  import("../plugins/types.js").ZuvixPluginNodeHostCommand;
export type ZuvixPluginNodeInvokePolicy =
  import("../plugins/types.js").ZuvixPluginNodeInvokePolicy;
export type ZuvixPluginNodeInvokePolicyContext =
  import("../plugins/types.js").ZuvixPluginNodeInvokePolicyContext;
export type ZuvixPluginNodeInvokePolicyResult =
  import("../plugins/types.js").ZuvixPluginNodeInvokePolicyResult;
export type ZuvixPluginReloadRegistration =
  import("../plugins/types.js").ZuvixPluginReloadRegistration;
export type ZuvixPluginSecurityAuditCollector =
  import("../plugins/types.js").ZuvixPluginSecurityAuditCollector;
export type ZuvixPluginSecurityAuditContext =
  import("../plugins/types.js").ZuvixPluginSecurityAuditContext;
export type ZuvixPluginService = import("../plugins/types.js").ZuvixPluginService;
export type ZuvixPluginServiceContext =
  import("../plugins/types.js").ZuvixPluginServiceContext;
export type ZuvixPluginToolContext = import("../plugins/types.js").ZuvixPluginToolContext;
export type ZuvixPluginToolFactory = import("../plugins/types.js").ZuvixPluginToolFactory;
...
export type ZuvixGatewayDiscoveryAdvertiseContext =
  import("../plugins/types.js").ZuvixGatewayDiscoveryAdvertiseContext;
export type ZuvixGatewayDiscoveryService =
  import("../plugins/types.js").ZuvixGatewayDiscoveryService;
...
type DefinePluginEntryOptions = {
   ...
   */
  kind?: ZuvixPluginDefinition["kind"];
  configSchema?: ZuvixPluginConfigSchema | (() => ZuvixPluginConfigSchema);
  reload?: ZuvixPluginDefinition["reload"];
  nodeHostCommands?: ZuvixPluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: ZuvixPluginDefinition["securityAuditCollectors"];
  register: (api: ZuvixPluginApi) => void;
};

/** Normalized object shape that Zuvix loads from a plugin entry module. */
type DefinedPluginEntry = {
  id: string;
  name: string;
  description: string;
  configSchema: ZuvixPluginConfigSchema;
  register: NonNullable<ZuvixPluginDefinition["register"]>;
} & Pick<
  ZuvixPluginDefinition,
 ...
 * `zuvix/plugin-sdk/core` so they inherit the channel capability wiring.
 */
