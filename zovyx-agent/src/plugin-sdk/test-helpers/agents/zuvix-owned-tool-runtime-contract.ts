// Zuvix-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installZuvixOwnedToolHooks(params?: {
 ...
 * Pair with `installZuvixOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetZuvixOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
