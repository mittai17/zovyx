...
import type { ModelDefinitionConfig, ZuvixConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: ZuvixConfig) => ZuvixConfig;
  applyLitellmProviderConfig: (cfg: ZuvixConfig) => ZuvixConfig;
...
/** Apply LiteLLM defaults to the full Zuvix config. */
