...
type ChannelConfigAccessorParams<Config extends ZuvixConfig = ZuvixConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends ZuvixConfig = ZuvixConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends ZuvixConfig = ZuvixConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: ZuvixConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends ZuvixConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends ZuvixConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends ZuvixConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
