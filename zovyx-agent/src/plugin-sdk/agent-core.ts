...
/** Runtime adapter that lets the package agent-core use Zuvix LLM helpers. */
export const zuvixAgentCoreRuntime = {
...
/** Agent-core class preconfigured with Zuvix runtime dependencies. */
export class Agent extends CoreAgent {
  constructor(options: CoreAgentOptions = {}) {
    super({ runtime: zuvixAgentCoreRuntime, ...options });
  }
}

// Zuvix-owned reusable agent core
