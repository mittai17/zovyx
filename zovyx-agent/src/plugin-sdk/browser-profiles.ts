...
export const DEFAULT_ZUVIX_BROWSER_ENABLED = true;
...
export const DEFAULT_ZUVIX_BROWSER_COLOR = "#FF4500";
/** Default Zuvix-managed browser profile name. */
export const DEFAULT_ZUVIX_BROWSER_PROFILE_NAME = "zuvix";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "zuvix";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredZuvixTmpDir(), "uploads");
