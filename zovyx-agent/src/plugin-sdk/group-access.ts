...
/** @deprecated Use `resolveChannelMessageIngress` from `zuvix/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `zuvix/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `zuvix/plugin-sdk/channel-ingress-runtime`. */
