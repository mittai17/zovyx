// Browser control auth helpers resolve plugin browser credentials from Zuvix config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: ZuvixConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
