...
const FACADE_LOADER_GLOBAL = "__zuvixTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("zuvix-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "zuvix-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "zuvix-facade-loader-b-",
      marker: "override-b",
    });

    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "zuvix-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = createTempDirSync("zuvix-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "zuvix-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "zuvix-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("zuvix-facade-loader-circular-");
    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("zuvix-facade-loader-throw-");
    process.env.ZUVIX_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
