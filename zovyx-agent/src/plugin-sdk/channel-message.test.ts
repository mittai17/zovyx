...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("zuvix/plugin-sdk/channel-outbound"),
      import("zuvix/plugin-sdk/channel-message"),
      import("zuvix/plugin-sdk/channel-message-runtime"),
      import("zuvix/plugin-sdk/channel-reply-pipeline"),
      import("zuvix/plugin-sdk/compat"),
    ] as const);
