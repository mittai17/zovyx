...
import type { ZuvixPluginApi } from "../plugins/types.js";
...
export type { ZuvixConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: ZuvixConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
