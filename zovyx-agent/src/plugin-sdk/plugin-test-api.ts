...
import {
  ...
  type ZuvixPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { ZuvixPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<ZuvixPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): ZuvixPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as ZuvixPluginApiWithoutFacades;
