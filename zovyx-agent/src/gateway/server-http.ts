        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __zuvixPreauthBudgetClaimed?: boolean;
              __zuvixPreauthBudgetKey?: string;
            }
          )["__zuvixPreauthBudgetKey"] = preauthBudgetKey;
