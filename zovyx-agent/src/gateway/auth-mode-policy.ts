...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ZuvixConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ZuvixConfig): void {
