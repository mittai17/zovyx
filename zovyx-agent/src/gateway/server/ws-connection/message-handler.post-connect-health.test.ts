...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["zuvix-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["zuvix-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["zuvix-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["zuvix-android", "Android 16", "Android 15", "Android"],
  ])(
