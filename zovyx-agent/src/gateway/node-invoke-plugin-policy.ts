...
import type {
  ...
  ZuvixPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): ZuvixPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: ZuvixPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
