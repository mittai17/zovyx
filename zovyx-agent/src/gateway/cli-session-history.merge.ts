...
// Deduplicates external history messages against local Zuvix transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__zuvix" in message &&
    (message as { __zuvix?: unknown })["__zuvix"] &&
    typeof (message as { __zuvix?: unknown })["__zuvix"] === "object"
      ? ((message as { __zuvix?: Record<string, unknown> })["__zuvix"] ?? {})
      : undefined;
