...
const DEEP_SLEEP_SYSTEM_EVENT_TEXT = "__zuvix_memory_core_short_term_promotion_dream__";
...
const SKIPPED_MEMORY_EMBEDDING_PROBE = {
  ok: false,
  checked: false,
  error: "memory embedding readiness not checked; run `zuvix memory status --deep` to probe",
} as const;
