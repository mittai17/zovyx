...
export function didSharedGatewayAuthChange(prev: ZuvixConfig, next: ZuvixConfig): boolean {
...
}): Promise<{ path: string; config: ZuvixConfig; queueFollowUp: () => void }> {
