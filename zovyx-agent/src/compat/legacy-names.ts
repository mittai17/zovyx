// Product/package naming constants that bridge current Zuvix manifests with
// legacy Clawdbot keys still seen in older configs and packages.
export const PROJECT_NAME = "zuvix" as const;
...
export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Zuvix" as const;
