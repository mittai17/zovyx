...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ZUVIX_GATEWAY_PORT = "";
  });
  ...
  it.each([
    ...
    {
      name: "uses ZUVIX_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
