...
export function resolveConfiguredMediaMaxBytes(cfg?: ZuvixConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: ZuvixConfig | undefined, kind: MediaKind) {
