...
function listConfiguredChannelIds(cfg: ZuvixConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: ZuvixConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: ZuvixConfig): ChannelRouteTarget[] {
