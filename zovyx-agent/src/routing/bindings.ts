...
export function listBindings(cfg: ZuvixConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: ZuvixConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ZuvixConfig) {
