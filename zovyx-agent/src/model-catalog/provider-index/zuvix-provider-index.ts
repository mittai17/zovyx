// Bundled Zuvix provider index advertises pre-install provider metadata for model picker discovery.
import type { ZuvixProviderIndex } from "./types.js";

// Zuvix-owned preview metadata for providers whose plugins may not be
...
export const ZUVIX_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
