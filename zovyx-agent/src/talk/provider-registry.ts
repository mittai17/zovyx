...
function resolveRealtimeVoiceProviderEntries(cfg?: ZuvixConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: ZuvixConfig): RealtimeVoiceProviderPlugin[] {
