...
export const SKILL_WORKSHOP_SCHEMA = "zuvix.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "zuvix.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "zuvix.skill-workshop.rollback.v1" as const;
