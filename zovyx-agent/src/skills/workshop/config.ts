// Workshop config helpers resolve skill workshop settings from Zuvix config.
...
export function resolveSkillWorkshopConfig(config?: ZuvixConfig): SkillWorkshopConfig {
