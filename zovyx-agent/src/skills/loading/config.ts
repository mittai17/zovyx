...
export function resolveSkillsInstallPreferences(config?: ZuvixConfig): SkillsInstallPreferences {
...
export function isConfigPathTruthy(config: ZuvixConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["zuvix-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: ZuvixConfig): ReadonlySet<string> | undefined {
