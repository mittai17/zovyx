  ...
  it("installs selected optional official plugins through the shared onboarding installer", async () => {
      ...
      expect.arrayContaining([
        {
          value: "acpx",
          label: "ACPX Runtime",
          hint: "Zuvix ACP runtime backend",
        },
        {
          value: "diagnostics-otel",
          label: "Diagnostics OpenTelemetry",
          hint: "Zuvix diagnostics OpenTelemetry exporter",
        },
        {
          value: "diagnostics-prometheus",
          label: "Diagnostics Prometheus",
          hint: "Zuvix diagnostics Prometheus exporter",
        },
        {
          value: "tokenjuice",
          label: "Tokenjuice",
          hint: "Zuvix tokenjuice exec output compaction plugin",
        },
      ]),
    );
    expect(ensureOnboardingPluginInstalled).toHaveBeenCalledExactlyOnceWith({
      ...
      entry: {
        ...
        label: "Diagnostics OpenTelemetry",
        description: "Zuvix diagnostics OpenTelemetry exporter",
        install: {
          clawhubSpec: "clawhub:@zuvix/diagnostics-otel",
          npmSpec: "@zuvix/diagnostics-otel",
          defaultChoice: "npm",
