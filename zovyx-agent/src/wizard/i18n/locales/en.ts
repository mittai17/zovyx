...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Zuvix config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `zuvix doctor` next.",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: ZUVIX_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in Zuvix config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in Zuvix config",
    ...
    security: {
      ...
      beta: "Zuvix is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run Zuvix.",
      learnMore: "Learn more",
      notMultitenant: "Zuvix is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, Zuvix is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.zuvix.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Zuvix" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Zuvix can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Zuvix",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: zuvix channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Zuvix uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Zuvix"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var ZUVIX_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: ZUVIX_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Zuvix with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with zuvix configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.zuvix.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Zuvix.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control Zuvix.",
      ...
      gatewayTokenStored:
        "Stored in: $ZUVIX_CONFIG_PATH (default: ~/.zuvix/zuvix.json) under gateway.auth.token, or in ZUVIX_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Zuvix.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Zuvix.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.zuvix.ai/security",
      ...
      webDocs: "Docs: https://docs.zuvix.ai/tools/web",
      ...
      whatNow: 'What now: https://zuvix.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.zuvix.ai/concepts/agent-workspace",
