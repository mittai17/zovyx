...
function resolveTranscriptsSourceProviderEntries(cfg?: ZuvixConfig): TranscriptSourceProvider[] {
...
function buildProviderMaps(cfg?: ZuvixConfig): {
...
export function listTranscriptSourceProviders(cfg?: ZuvixConfig): TranscriptSourceProvider[] {
