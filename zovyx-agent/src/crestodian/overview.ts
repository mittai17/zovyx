...
type ZuvixReferencePaths = Awaited<ReturnType<typeof resolveZuvixReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveZuvixReferencePaths?: typeof resolveZuvixReferencePaths;
};
...
function buildAgentSummaries(cfg: ZuvixConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): ZuvixReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveZuvixReferencePaths ?? resolveZuvixReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: ZUVIX_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: ZUVIX_SOURCE_URL,
    },
  };
}
