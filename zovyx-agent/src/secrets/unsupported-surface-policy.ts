...
// Candidate scanning only sees zuvix.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an zuvix.json-like object.
 */
...
/**
 * Finds configured zuvix.json values whose surfaces currently reject SecretRef objects.
 */
