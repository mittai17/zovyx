...
function hasConfiguredPluginEntries(config: ZuvixConfig): boolean {
...
function hasConfiguredChannelEntries(config: ZuvixConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: ZuvixConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: ZuvixConfig): boolean {
  return (
