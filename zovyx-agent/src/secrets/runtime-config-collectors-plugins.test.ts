...
function makeContext(sourceConfig: ZuvixConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: ZuvixConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: ZuvixConfig): void {
