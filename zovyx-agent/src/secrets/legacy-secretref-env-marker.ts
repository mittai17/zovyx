...
function toCandidate(
  ...
  defaults: NonNullable<ZuvixConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: ZuvixConfig): {
  config: ZuvixConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as ZuvixConfig & Record<string, unknown>;
