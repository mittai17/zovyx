...
function resolveHeartbeatConfig(cfg: ZuvixConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: ZuvixConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: ZuvixConfig): string[] {
