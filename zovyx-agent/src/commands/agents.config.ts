// Agent config mutation and summary builders used by `zuvix agents` commands.
import {
...
function resolveAgentModel(cfg: ZuvixConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: ZuvixConfig): AgentSummary[] {
