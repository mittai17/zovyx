...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `zuvix doctor --fix`.";
    case "module-missing":
      return "Fix: run `zuvix doctor --fix`.";
    case "service-missing":
      return "Fix: run `zuvix gateway install --force`.";
    case "service-stopped":
      return "Fix: run `zuvix gateway restart`.";
    case "startup-blocked":
      return "Fix: run `zuvix gateway status --deep`.";
    case "not-listening":
      return "Fix: start `zuvix gateway run`, or run `zuvix gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
