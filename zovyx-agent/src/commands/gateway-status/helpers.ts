...
import type { ZuvixConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: ZuvixConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
/** Extracts the config fields displayed by `zuvix gateway status --deep`. */
...
export function buildNetworkHints(cfg: ZuvixConfig) {
