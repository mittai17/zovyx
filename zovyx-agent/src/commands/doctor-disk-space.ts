/** Doctor contribution for low disk space around the Zuvix state directory. */
 ...
 *
 * This catches a common operational failure mode where Zuvix silently
...
export function noteDiskSpace(
  _cfg: ZuvixConfig, // reserved for API consistency with other Doctor contributions
  deps?: {
