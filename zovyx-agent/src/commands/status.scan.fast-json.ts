// Fast `zuvix status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: ZuvixConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: ZuvixConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: ZuvixConfig): boolean {
