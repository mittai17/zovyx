...
describe("channels list", () => {
  ...
  it("default output shows configured official external channels when the plugin is missing", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHint.mockReturnValue({
      ...
      channelId: "discord",
      label: "Discord",
      installSpec: "@zuvix/discord",
      installCommand: "zuvix plugins install @zuvix/discord",
      doctorFixCommand: "zuvix doctor --fix",
      repairHint:
        "Install the official external plugin with: zuvix plugins install @zuvix/discord, or run: zuvix doctor --fix.",
    });
    mocks.readConfigFileSnapshot.mockResolvedValue({
      ...baseConfigSnapshot,
      config: {
    ...
    expect(output).toContain(
      "run zuvix plugins install @zuvix/discord or zuvix doctor --fix",
    );
