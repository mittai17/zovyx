...
function collectExecSafeBinScopes(cfg: ZuvixConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: ZuvixConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: ZuvixConfig): {
  config: ZuvixConfig;
  changes: string[];
  warnings: string[];
} {
