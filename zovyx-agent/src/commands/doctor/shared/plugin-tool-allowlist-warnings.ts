...
function collectToolAllowlistSources(cfg: ZuvixConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: ZuvixConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: ZuvixConfig): string[] {
