...
export const UPDATE_IN_PROGRESS_ENV = "ZUVIX_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "ZUVIX_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `ZUVIX_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `ZUVIX_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
