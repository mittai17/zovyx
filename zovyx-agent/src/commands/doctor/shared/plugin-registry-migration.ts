...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "ZUVIX_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "ZUVIX_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<ZuvixConfig> | ZuvixConfig;
  };
...
function listConfiguredChannelIds(config: ZuvixConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: ZuvixConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as ZuvixConfig;
