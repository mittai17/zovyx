...
export function collectMissingDefaultAccountBindingWarnings(cfg: ZuvixConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: ZuvixConfig): string[] {
  const warnings: string[] = [];
