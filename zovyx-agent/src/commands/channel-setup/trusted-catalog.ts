...
function resolveEffectiveTrustConfig(cfg: ZuvixConfig, env?: NodeJS.ProcessEnv): ZuvixConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: ZuvixConfig): string[] | undefined {
