...
import { isZuvixOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function shouldFallbackClawHubToNpm(params: {
  ...
  // Only official Zuvix npm packages are safe fallback targets for ClawHub
...
function addPluginLoadPath(cfg: ZuvixConfig, pluginPath: string): ZuvixConfig {
