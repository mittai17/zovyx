...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: ZuvixConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: ZuvixConfig, deps?: BrowserDoctorDeps) {
  try {
