      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run zuvix plugins install @zuvix/feishu or zuvix doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run zuvix doctor --fix",
        },
      ],
      details: [],
    });
