...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://zuvix.local")).toBe("https://zuvix.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://zuvix.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: zuvix security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://zuvix.local" },
      ...
      { Item: "Security", Value: "Run: zuvix security audit --deep" },
