/**
 * Hook system for Zuvix agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("zuvix.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("zuvix.internalHooksEnabled");
