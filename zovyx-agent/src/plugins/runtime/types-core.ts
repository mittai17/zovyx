...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.zuvix.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.zuvix.js").ZuvixConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.zuvix.js").ZuvixConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.zuvix.js").ZuvixConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.zuvix.js").ZuvixConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.zuvix.js").ZuvixConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@zuvix/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@zuvix/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("zuvix/plugin-sdk/llm").Model<import("zuvix/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.zuvix.js").ZuvixConfig;
      workspaceDir?: string;
