...
function isPluginEnabled(config: ZuvixConfig | undefined, pluginId: string): boolean {
 ...
 *   `version` field of the installed zuvix package.json).
 ...
 * @param params.config The merged daemon-side ZuvixConfig (optional).
