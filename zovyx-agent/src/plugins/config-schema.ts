...
import type { ZuvixPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: ZuvixPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): ZuvixPluginConfigSchema {
  return {
