...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/zuvix-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/zuvix-weixin@2.3.7",
    installPath:
      "/tmp/zuvix-test-home/.zuvix/npm/node_modules/@tencent-weixin/zuvix-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverZuvixPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/zuvix-test-plugin/index.js",
    rootDir: "/tmp/zuvix-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/zuvix-test-plugin",
    packageManifest: {
