...
import type { ClawdbotConfig, ZuvixConfig, ZuvixSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<ZuvixConfig>();
    expectTypeOf<ZuvixSchemaType>().toEqualTypeOf<ZuvixConfig>();
  });
