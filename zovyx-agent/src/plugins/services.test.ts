...
import type { ZuvixPluginService, ZuvixPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: ZuvixPluginServiceContext) {
...
function expectServiceContexts(
  contexts: ZuvixPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: ZuvixPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: ZuvixPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: ZuvixPluginServiceContext[] = [];
    ...
    const officialInstallContexts: ZuvixPluginServiceContext[] = [];
    ...
    const untrustedContexts: ZuvixPluginServiceContext[] = [];
    ...
    const spoofedContexts: ZuvixPluginServiceContext[] = [];
