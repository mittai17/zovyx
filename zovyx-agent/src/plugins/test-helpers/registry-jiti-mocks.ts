...
vi.mock("../discovery.js", () => ({
  discoverZuvixPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverZuvixPlugins>
  ) => registryJitiMocks.discoverZuvixPlugins(...args),
}));
