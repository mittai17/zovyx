...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "ZUVIX_PLUGIN_INSTALL_OVERRIDES";
/** Env var gate that must be enabled before install overrides are honored. */
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "ZUVIX_ALLOW_PLUGIN_INSTALL_OVERRIDES";
