...
} & PluginActivationConfigSourceLike<ZuvixConfig>;
...
const hasExplicitMemorySlot = (plugins?: ZuvixConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.hasOwn(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ZuvixConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.hasOwn(plugins.entries, defaultSlotIdForKey("memory")));

export const hasExplicitPluginConfig = (plugins?: ZuvixConfig["plugins"]) =>
