...
import { normalizeZuvixVersionBase } from "../config/version.js";
...
import { loadZuvixPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeZuvixVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeZuvixVersionBase(plugin.version) ??
    plugin.version
  );
}
