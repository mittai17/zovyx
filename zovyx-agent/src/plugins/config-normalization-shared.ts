...
import { normalizeArrayBackedTrimmedStringList } from "@zuvix/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: ZuvixConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
