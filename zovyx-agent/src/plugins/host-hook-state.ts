...
function loadPluginHostHookSessionEntry(params: { cfg: ZuvixConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: ZuvixConfig, pluginId: string): boolean {
