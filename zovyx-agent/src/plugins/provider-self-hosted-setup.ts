...
export function applyProviderDefaultModel(cfg: ZuvixConfig, modelRef: string): ZuvixConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: ZuvixConfig; modelId: string; modelRef: string; profileId: string } {
