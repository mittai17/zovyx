...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Zuvix from plugin manifests, install records, and config policy. Use `zuvix plugins registry --refresh`, `zuvix plugins install/update/uninstall`, or `zuvix plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored zuvix.install metadata. This describes catalog/package
