/** Tests bundle manifest parsing for Codex, Claude, Cursor, and Zuvix formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("zuvix-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat zuvix.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "zuvix.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
