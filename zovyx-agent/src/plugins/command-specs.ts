...
import type { ZuvixPluginCommandDefinition } from "./types.js";
...
function resolvePluginTextName(command: ZuvixPluginCommandDefinition): string {
...
function serializePluginCommandSpec(
  cmd: ZuvixPluginCommandDefinition,
  provider?: string,
): {
  name: string;
  description: string;
