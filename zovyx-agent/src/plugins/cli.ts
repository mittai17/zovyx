...
import type { ZuvixPluginCliCommandDescriptor, PluginLogger } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("zuvix.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<ZuvixConfig | null> => {
