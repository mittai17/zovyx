...
import {
  ...
  type ZuvixPluginCommandDefinition,
} from "./types.js";
...
/** Returns true when a command name is owned by built-in Zuvix command handling. */
...
export function listPluginInvocationKeys(command: ZuvixPluginCommandDefinition): string[] {
