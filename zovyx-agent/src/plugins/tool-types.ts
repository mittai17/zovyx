...
export type ZuvixPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type ZuvixPluginToolContext = {
  config?: ZuvixConfig;
   ...
   * the local operator, installed plugin code, or a modified Zuvix runtime.
   */
  activeModel?: ZuvixPluginActiveModelContext;
  browser?: {
...
export type ZuvixPluginToolFactory = (
  ctx: ZuvixPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ZuvixPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ZuvixPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
