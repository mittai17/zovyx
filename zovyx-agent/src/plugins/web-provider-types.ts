...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: ZuvixConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: ZuvixConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: ZuvixConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: ZuvixConfig) => ZuvixConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => ZuvixConfig | Promise<ZuvixConfig>;
