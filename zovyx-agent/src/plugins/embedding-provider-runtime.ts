...
export function listEmbeddingProviders(cfg?: ZuvixConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: ZuvixConfig): string[] {
