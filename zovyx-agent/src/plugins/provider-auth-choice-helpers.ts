...
function normalizeModelProviderConfigsForWrite(cfg: ZuvixConfig): ZuvixConfig {
...
function normalizeConfigModelRefsForWrite(cfg: ZuvixConfig): ZuvixConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<ZuvixConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });
