...
import type { AnyAgentTool, ZuvixPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: ZuvixPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: ZuvixPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
