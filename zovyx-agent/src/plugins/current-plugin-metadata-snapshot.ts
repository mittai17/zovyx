...
import { setCurrentManifestModelIdNormalizationRecords } from "@zuvix/model-catalog-core/provider-model-id-normalization";
...
let currentPluginMetadataConfigIdentityCache = new WeakSet<ZuvixConfig>();
...
export function setCurrentPluginMetadataSnapshot(
  ...
  options: {
    config?: ZuvixConfig;
    compatibleConfigs?: readonly ZuvixConfig[];
