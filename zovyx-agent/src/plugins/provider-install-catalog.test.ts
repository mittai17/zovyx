...
type LoadZuvixProviderIndex =
  typeof import("../model-catalog/index.js").loadZuvixProviderIndex;
...
const loadZuvixProviderIndex = vi.hoisted(() =>
  vi.fn<LoadZuvixProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.zuvix/plugins/vllm/zuvix.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.zuvix/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    compat: [],
    packageName: "@zuvix/vllm",
    packageInstall: {
      npm: {
        spec: "@zuvix/vllm-fork@1.0.0",
        packageName: "@zuvix/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadZuvixProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/zuvix.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@zuvix/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@zuvix/openai@1.2.3",
              packageName: "@zuvix/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "clawhub",
            spec: "clawhub:zuvix/vllm@2026.5.2",
            integrity: "sha256-clawpack",
            clawhubPackage: "zuvix/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:zuvix/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.zuvix/plugins/demo-provider/zuvix.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.zuvix/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/zuvix.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadZuvixProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
          ...
          plugin: {
            id: "moonshot",
            package: "@zuvix/plugin-moonshot",
            install: {
              npmSpec: "@zuvix/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@zuvix/plugin-moonshot@1.2.3",
          packageName: "@zuvix/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@zuvix/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:zuvix/moonshot@2026.5.2",
              npmSpec: "@zuvix/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:zuvix/moonshot@2026.5.2",
          packageName: "zuvix/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@zuvix/plugin-moonshot@2026.5.2",
          packageName: "@zuvix/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/zuvix.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadZuvixProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@zuvix/plugin-groq",
            install: {
              npmSpec: "@zuvix/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@zuvix/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:zuvix/vllm@2026.5.2",
              npmSpec: "@zuvix/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@zuvix/plugin-vllm@2026.5.2",
          packageName: "@zuvix/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
