/** Reads Codex/Claude/Cursor bundle manifests into Zuvix plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that Zuvix can execute via HOOK.md + handler files.
  hooks: string[];
