...
function primeConfiguredContextWindowsFromConfig(cfg: ZuvixConfig): ZuvixConfig {
...
function primeConfiguredContextWindows(): ZuvixConfig | undefined {
...
export async function refreshContextWindowCache(cfg: ZuvixConfig): Promise<void> {
  beginContextWindowCacheRefresh();
