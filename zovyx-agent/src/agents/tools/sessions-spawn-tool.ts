...
// Keep the schema local to avoid a circular import through acp-spawn/zuvix-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: ZuvixConfig }) {
