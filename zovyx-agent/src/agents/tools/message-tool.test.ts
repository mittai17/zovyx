...
type CreateZuvixTools = typeof import("../zuvix-tools.js").createZuvixTools;
...
let createZuvixTools: CreateZuvixTools;
...
const zuvixToolsFactoryMocks = vi.hoisted(() => {
...
vi.mock("./agents-list-tool.js", () => ({
  createAgentsListTool: () => zuvixToolsFactoryMocks.tool("agents"),
}));
vi.mock("./cron-tool.js", () => ({
  createCronTool: () => zuvixToolsFactoryMocks.tool("cron"),
}));
vi.mock("./gateway-tool.js", () => ({
  createGatewayTool: () => zuvixToolsFactoryMocks.tool("gateway"),
}));
vi.mock("./heartbeat-response-tool.js", () => ({
  createHeartbeatResponseTool: () => zuvixToolsFactoryMocks.tool("heartbeat_response"),
}));
...
vi.mock("./nodes-tool.js", () => ({
  createNodesTool: () => zuvixToolsFactoryMocks.tool("nodes"),
}));
vi.mock("./pdf-tool.js", () => ({
  createPdfTool: () => null,
}));
vi.mock("./session-status-tool.js", () => ({
  createSessionStatusTool: () => zuvixToolsFactoryMocks.tool("session_status"),
}));
vi.mock("./sessions-history-tool.js", () => ({
  createSessionsHistoryTool: () => zuvixToolsFactoryMocks.tool("sessions_history"),
}));
vi.mock("./sessions-list-tool.js", () => ({
  createSessionsListTool: () => zuvixToolsFactoryMocks.tool("sessions_list"),
}));
vi.mock("./sessions-send-tool.js", () => ({
  createSessionsSendTool: () => zuvixToolsFactoryMocks.tool("sessions_send"),
}));
vi.mock("./sessions-spawn-tool.js", () => ({
  createSessionsSpawnTool: () => zuvixToolsFactoryMocks.tool("sessions_spawn"),
}));
vi.mock("./sessions-yield-tool.js", () => ({
  createSessionsYieldTool: () => zuvixToolsFactoryMocks.tool("sessions_yield"),
}));
vi.mock("./subagents-tool.js", () => ({
  createSubagentsTool: () => zuvixToolsFactoryMocks.tool("subagents"),
}));
vi.mock("./tts-tool.js", () => ({
  createTtsTool: () => zuvixToolsFactoryMocks.tool("tts"),
}));
vi.mock("./update-plan-tool.js", () => ({
  createUpdatePlanTool: () => zuvixToolsFactoryMocks.tool("update_plan"),
}));
vi.mock("./video-generate-tool.js", () => ({
  createVideoGenerateTool: () => null,
}));
vi.mock("./web-tools.js", () => ({
  createWebFetchTool: () => zuvixToolsFactoryMocks.tool("web_fetch"),
  createWebSearchTool: () => zuvixToolsFactoryMocks.tool("web_search"),
}));
...
beforeAll(async () => {
  ...
  ({ createZuvixTools } = await import("../zuvix-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createZuvixTools", () => {
    const tool = createZuvixTools({
      config: {} as never,
      sourceReplyDeliveryMode: "message_tool_only",
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createZuvixTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
    const plugin = createChannelPlugin({
      id: "slack",
      label: "Slack",
  ...
  it("forwards the routable target through createZuvixTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "user:U123" });
    const plugin = createChannelPlugin({
      id: "slack",
      label: "Slack",
