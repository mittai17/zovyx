...
/** Resolves the configured default model ref, falling back to Zuvix defaults. */
export function resolveDefaultModelRef(cfg?: ZuvixConfig): { provider: string; model: string } {
  if (cfg) {
