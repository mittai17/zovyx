...
function hasExplicitDefaultPrimaryModel(cfg?: ZuvixConfig): boolean {
...
function pickMaxBytes(cfg?: ZuvixConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: ZuvixConfig = effectiveCfg ?? {};
