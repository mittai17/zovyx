...
Main cron => system events for heartbeat. Isolated cron => background task in \`zuvix tasks\`.
    ...
    execute: async (_toolCallId, args) => {
      ...
      switch (action) {
        ...
        case "add": {
          ...
          // See: https://github.com/zuvix/zuvix/issues/11310
        ...
        case "wake": {
          ...
          // upstream half of zuvix/zuvix#46886 (#64556 — agentId/
