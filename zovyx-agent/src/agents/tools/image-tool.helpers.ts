...
export function coerceImageModelConfig(cfg?: ZuvixConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: ZuvixConfig; ref: string }): string[] {
