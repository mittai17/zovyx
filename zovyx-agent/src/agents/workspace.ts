...
const WORKSPACE_STATE_DIRNAME = ".zuvix";
...
const WORKSPACE_ATTESTATION_HEADER = "zuvix-workspace-attestation:v1";
...
export class WorkspaceVanishedError extends Error {
  ...
  constructor(params: { workspaceDir: string; attestationPath: string }) {
    super(
      `Zuvix workspace appears to have disappeared after a recent initialization: ${params.workspaceDir}. ` +
