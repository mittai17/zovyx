...
const contextTestState = vi.hoisted(() => {
  const state = {
    ...
    runtimeConfigSnapshot: null as ZuvixConfig | null,
    runtimeConfigSourceSnapshot: null as ZuvixConfig | null,
...
vi.mock("../config/runtime-source-projection.js", () => ({
  projectConfigOntoRuntimeSourceSnapshot: (config: ZuvixConfig) =>
