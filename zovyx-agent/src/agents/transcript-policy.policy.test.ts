...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.ZUVIX_BUNDLED_PLUGINS_DIR;
  delete env.ZUVIX_SKIP_PROVIDERS;
  delete env.ZUVIX_SKIP_CHANNELS;
  delete env.ZUVIX_SKIP_CRON;
  delete env.ZUVIX_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
