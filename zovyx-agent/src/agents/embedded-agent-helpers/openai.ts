 ...
 * pairs directly into the provider payload, so Zuvix must normalize here.
 */
 ...
 *
 * Zuvix persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
