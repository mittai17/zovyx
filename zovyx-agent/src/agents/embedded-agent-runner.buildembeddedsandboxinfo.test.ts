...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/zuvix-sandbox",
    agentWorkspaceDir: "/tmp/zuvix-workspace",
    workspaceAccess: "none",
    runtimeId: "zuvix-sbx-test",
    runtimeLabel: "zuvix-sbx-test",
    containerName: "zuvix-sbx-test",
    ...
    browser: {
      ...
      containerName: "zuvix-sbx-browser-test",
    },
