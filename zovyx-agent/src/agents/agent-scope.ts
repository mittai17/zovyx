...
function findMutableAgentEntry(cfg: ZuvixConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: ZuvixConfig, agentId: string): string | undefined {
