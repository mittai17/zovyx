...
export const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "ZUVIX_AGENT_CLEANUP_TIMEOUT_MS";
export const TRAJECTORY_FLUSH_TIMEOUT_ENV = "ZUVIX_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
export function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "zuvix-trajectory-flush") {
