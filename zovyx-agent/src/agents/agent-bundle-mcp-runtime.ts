...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("zuvix.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: ZuvixConfig): number {
