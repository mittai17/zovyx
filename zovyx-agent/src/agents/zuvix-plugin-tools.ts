...
import {
  resolveZuvixPluginToolInputs,
  type ZuvixPluginToolOptions,
} from "./zuvix-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveZuvixPluginToolsOptions = ZuvixPluginToolOptions & {
...
export function resolveZuvixPluginToolsForOptions(params: {
  options?: ResolveZuvixPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveZuvixPluginToolInputs({
