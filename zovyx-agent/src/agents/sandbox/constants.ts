...
export const DEFAULT_SANDBOX_IMAGE = "zuvix-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "zuvix-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "zuvix-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "zuvix-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "zuvix-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "zuvix-sandbox-browser";
