...
async function resolveContext(config: ZuvixConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): ZuvixConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
