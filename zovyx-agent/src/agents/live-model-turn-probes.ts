...
export const LIVE_MODEL_FILE_PROBE_ENV = "ZUVIX_LIVE_MODEL_FILE_PROBE";
/** Environment toggle for live image probes. */
export const LIVE_MODEL_IMAGE_PROBE_ENV = "ZUVIX_LIVE_MODEL_IMAGE_PROBE";
...
const KNOWN_EMPTY_FILE_PROBE_MODELS = new Set([
  ...
  "zuvix-go/glm-5",
  "zuvix-go/glm-5.1",
  "zuvix-go/mimo-v2-omni",
  "zuvix-go/mimo-v2-pro",
  "zuvix-go/minimax-m2.5",
