...
import * as agentSessions from "zuvix/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "zuvix/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("zuvix/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("zuvix/plugin-sdk/agent-sessions");
  return {
    ...actual,
