// Covers conversion from Zuvix bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes Zuvix MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      zuvix: {
        ...
        bearer_token_env_var: "ZUVIX_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
