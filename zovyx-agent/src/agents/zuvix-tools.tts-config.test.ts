// Verifies createZuvixTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { ZuvixConfig } from "../config/types.zuvix.js";
import { testing, createZuvixTools } from "./zuvix-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/zuvix/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./zuvix-plugin-tools.js", () => ({
  resolveZuvixPluginToolsForOptions: () => [],
}));

vi.mock("./zuvix-tools.nodes-workspace-guard.js", () => ({
...
describe("createZuvixTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createZuvixTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createZuvixTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createZuvixTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
