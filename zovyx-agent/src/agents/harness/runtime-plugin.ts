...
import { isDefaultAgentRuntimeId, ZUVIX_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
 ...
 *
 * Only cold-loadable runtimes live here; always-loaded core/zuvix runtimes should not trigger
...
function restrictiveAllowlistOmitsPlugin(config: ZuvixConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === ZUVIX_AGENT_RUNTIME_ID ||
