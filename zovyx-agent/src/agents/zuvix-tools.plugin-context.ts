/**
 * Runtime context resolver for Zuvix plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Zuvix plugin tools. */
...
export function resolveZuvixPluginToolInputs(params: {
  options?: ZuvixPluginToolOptions;
