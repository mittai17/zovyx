...
type ModelsConfig = NonNullable<ZuvixConfig["models"]>;
...
export async function planZuvixModelsJsonWithDeps(
  params: {
    cfg: ZuvixConfig;
...
export async function planZuvixModelsJson(
  params: Parameters<typeof planZuvixModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planZuvixModelsJsonWithDeps(params);
}
