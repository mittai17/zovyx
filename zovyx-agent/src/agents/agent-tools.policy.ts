...
export function resolveSubagentToolPolicy(cfg?: ZuvixConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: ZuvixConfig["tools"]): string[] | undefined {
