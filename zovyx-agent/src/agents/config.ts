...
export function getPackageDir(): string {
  ...
  const envDir = process.env.ZUVIX_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json zuvixConfig)
// =============================================================================
...
const zuvixConfigName: string | undefined = pkg.zuvixConfig?.name;
export const APP_NAME: string = zuvixConfigName || "zuvix";
export const CONFIG_DIR_NAME: string = pkg.zuvixConfig?.configDir || ".zuvix";
...
// =============================================================================
// User Config Paths (~/.zuvix/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.zuvix/agent/) */
