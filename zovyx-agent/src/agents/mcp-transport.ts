 ...
 * streamable-HTTP SDK transports with Zuvix auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: ZuvixStdioClientTransport) {
