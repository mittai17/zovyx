...
const CODE_MODE_NAMESPACE_TOOL_CALL = Symbol.for("zuvix.codeMode.namespaceToolCall");
...
const CODE_MODE_NAMESPACE_REGISTRY_KEY = Symbol.for("zuvix.codeMode.namespaces");
...
function normalizeRegistration(
  ...
  if (RESERVED_NAMESPACE_GLOBALS.has(globalName) || globalName.startsWith("__zuvix")) {
