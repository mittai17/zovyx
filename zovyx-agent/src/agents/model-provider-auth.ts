...
const configFingerprintCache = new WeakMap<ZuvixConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: ZuvixConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: ZuvixConfig): {
