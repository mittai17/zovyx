 ...
 *
 * Wraps pi-tui keybindings with Zuvix-specific actions and per-agent overrides.
 */
...
/** Zuvix-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Union of Zuvix-specific app key ids. */
...
/** Keybinding manager that loads Zuvix defaults plus optional user overrides. */
