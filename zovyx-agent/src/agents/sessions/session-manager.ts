 ...
 * Encodes cwd into a safe directory name under ~/.zuvix/agent/sessions/.
 */
...
export class SessionManager {
   ...
   * @param sessionDir Optional session directory. If omitted, uses default (~/.zuvix/agent/sessions/<encoded-cwd>/).
   */
