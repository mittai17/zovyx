...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[zuvix] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "zuvixSyntheticMissingToolResult";
...
function makeMissingToolResult(params: {
  ...
  // explicit Zuvix diagnostic text unless the caller opts in.
  text?: string;
