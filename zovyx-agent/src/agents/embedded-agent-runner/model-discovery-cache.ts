...
function authFingerprint(agentDir: string): object {
  return {
    authProfilesSqlite: fileFingerprint(path.join(agentDir, "zuvix-agent.sqlite")),
    authProfilesSqliteWal: fileFingerprint(path.join(agentDir, "zuvix-agent.sqlite-wal")),
  };
}
