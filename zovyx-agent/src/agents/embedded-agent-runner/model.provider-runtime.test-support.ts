...
import { lowercasePreservingWhitespace } from "@zuvix/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "zuvix configure". ' +
            "See: https://docs.zuvix.ai/providers/vllm"
          );
        default:
          return undefined;
      }
