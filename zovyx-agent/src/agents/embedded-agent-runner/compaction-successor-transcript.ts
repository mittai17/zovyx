...
import { resolveTimestampMsToIsoString } from "@zuvix/normalization-core/number-coercion";
...
export function shouldRotateCompactionTranscript(config?: ZuvixConfig): boolean {
