...
import { createZuvixCodingTools, resolveProcessToolScopeKey } from "../agent-tools.js";
...
async function compactEmbeddedAgentSessionDirectOnce(
  ...
  try {
    ...
    const toolsRaw = createZuvixCodingTools({
      exec: {
    ...
    const filteredBundledTools = applyFinalEffectiveToolPolicy({
      ...
      // createZuvixCodingTools(...) also omit it, so both paths resolve
    ...
    try {
      ...
      // exact Zuvix-managed registrations so custom tools survive startup.
