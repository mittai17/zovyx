...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ZuvixConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ZuvixConfig; env: NodeJS.ProcessEnv }): {
  cfg: ZuvixConfig;
  changes: string[];
} {
