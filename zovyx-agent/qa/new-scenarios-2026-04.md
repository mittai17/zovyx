...
- Code: `.agents/skills/zuvix-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/zuvix-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
