...
export type ThemeName = "nova" | "claw" | "knot" | "dash" | "custom";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["nova", "claw", "knot", "dash", "custom"]);
const VALID_THEME_MODES = new Set<ThemeMode>(["system", "light", "dark"]);

type ThemeSelection = { theme: ThemeName; mode: ThemeMode };

const LEGACY_MAP: Record<string, ThemeSelection> = {
  defaultTheme: { theme: "nova", mode: "dark" },
  docsTheme: { theme: "nova", mode: "light" },
  lightTheme: { theme: "nova", mode: "dark" },
  landingTheme: { theme: "nova", mode: "dark" },
  newTheme: { theme: "nova", mode: "dark" },
  dark: { theme: "nova", mode: "dark" },
  light: { theme: "nova", mode: "light" },
  openknot: { theme: "knot", mode: "dark" },
  fieldmanual: { theme: "dash", mode: "dark" },
  clawdash: { theme: "dash", mode: "light" },
  system: { theme: "nova", mode: "system" },
};
