...
describe("renderSkills", () => {
  ...
  it("opens detail dialogs and routes ClawHub actions", async () => {
          ...
          clawhubResults: [
            {
              ...
              slug: "github",
              displayName: "GitHub",
              summary: "GitHub integration for Zuvix",
              version: "1.2.3",
            },
          ],
          onClawHubDetailOpen,
    ...
    expect(normalizeText(container.querySelector(".md-preview-dialog__body")!)).toBe(
      "GitHub integration for Zuvix By Zuvix (@zuvix) Latest: v1.2.3 Added search support Platforms: macos, linux Install GitHub",
    );
        ...
        createProps({
          ...
          clawhubVerdicts: {
            [verdictKey]: {
              ...
              version: "1.2.3",
              securityAuditUrl:
                "https://clawhub.ai/zuvix/agentreceipt/security-audit?version=1.2.3",
