...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.zuvix.ai/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.zuvix.ai/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.zuvix.ai/web/control-ui#insecure-http",
      ...
      <div class="login-gate__card">
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="ZUVIX_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("zuvix gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("zuvix dashboard")}</li>
