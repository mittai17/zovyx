  ...
  return (
    <div className="modal" style={{ padding: '2rem', maxWidth: '600px', margin: '2rem auto', borderRadius: '16px' }}>
      ...
      <p style={{ marginBottom: '2rem', textAlign: 'center' }}>
        Skip the lengthy Zuvix configuration. Just drop your API keys here and they will be securely stored in the Supabase Vault!
      </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <input 
          ...
          type="password" 
          placeholder="OpenAI API Key (for Zuvix)" 
          value={keys.openai}
