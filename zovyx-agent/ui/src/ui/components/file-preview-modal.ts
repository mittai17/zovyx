...
export class ZuvixFilePreviewModal extends LitElement {
...
if (!customElements.get("zuvix-file-preview-modal")) {
  customElements.define("zuvix-file-preview-modal", ZuvixFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "zuvix-file-preview-modal": ZuvixFilePreviewModal;
  }
}
