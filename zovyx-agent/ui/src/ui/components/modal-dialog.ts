...
export class ZuvixModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "zuvix-modal-dialog-label" : "";
    const descriptionId = this.description ? "zuvix-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("zuvix-modal-dialog")) {
  customElements.define("zuvix-modal-dialog", ZuvixModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "zuvix-modal-dialog": ZuvixModalDialog;
  }
}
