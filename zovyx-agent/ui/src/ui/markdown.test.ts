...
function withControlUiBasePath<T>(basePath: string, fn: () => T): T {
  Object.defineProperty(window, "__ZUVIX_CONTROL_UI_BASE_PATH__", {
    value: basePath,
    writable: true,
    configurable: true,
  });
  try {
    ...
    delete window["__ZUVIX_CONTROL_UI_BASE_PATH__"];
  }
}
...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/zuvix");
      expect(html).toBe(
        '<p>Visit <a href="http://github.com/zuvix" rel="noreferrer noopener" target="_blank">http://github.com/zuvix</a></p>\n',
      );
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Zuvix中文](https://docs.zuvix.ai)");
      expect(html).toBe(
        '<p><a href="https://docs.zuvix.ai" rel="noreferrer noopener" target="_blank">Zuvix中文</a></p>\n',
      );
    });
...
`;
  ...
  describe("security", () => {
    ...
    it("strips href from host-local absolute file paths", () => {
      const html = toSanitizedMarkdownHtml(
        "[report.docx](/Users/test/.zuvix/data/skills/output/report.docx)",
      );
    ...
    it("rewrites docs-root links to the public docs host", () => {
      ...
      expect(html).toBe(
        '<p><a href="https://docs.zuvix.ai/concepts/agent-workspace" rel="noreferrer noopener" target="_blank">workspace</a> <a href="https://docs.zuvix.ai/automation/hooks#session-memory" rel="noreferrer noopener" target="_blank">hooks</a> <a href="https://docs.zuvix.ai/channels/telegram?tab=setup" rel="noreferrer noopener" target="_blank">telegram</a> <a href="https://docs.zuvix.ai/telegram" rel="noreferrer noopener" target="_blank">shortlink</a> <a href="https://docs.zuvix.ai/openai" rel="noreferrer noopener" target="_blank">openai</a> <a href="https://docs.zuvix.ai/images" rel="noreferrer noopener" target="_blank">images</a> <a href="https://docs.zuvix.ai/groups" rel="noreferrer noopener" target="_blank">groups</a> <a href="https://docs.zuvix.ai/nodes/camera" rel="noreferrer noopener" target="_blank">camera</a> <a href="https://docs.zuvix.ai/platforms/macos" rel="noreferrer noopener" target="_blank">macOS</a> <a href="https://docs.zuvix.ai/cli/sessions" rel="noreferrer noopener" target="_blank">cliSessions</a> <a href="https://docs.zuvix.ai/tools/skills" rel="noreferrer noopener" target="_blank">toolSkills</a> <a href="https://docs.zuvix.ai/plugins/reference/diffs" rel="noreferrer noopener" target="_blank">pluginDocs</a> <a href="https://docs.zuvix.ai/prose" rel="noreferrer noopener" target="_blank">prose</a> <a href="https://docs.zuvix.ai/refactor/ingress-core" rel="noreferrer noopener" target="_blank">refactor</a></p>\n',
      );
    });
