...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من zuvix dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام zuvix models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "الصق الرمز المميز من zuvix dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل zuvix doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل zuvix dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل zuvix devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: zuvix devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "أعد فتح لوحة المعلومات المقدمة باستخدام zuvix dashboard حتى يأتي UI وGateway من التثبيت نفسه.",
        stepDevUi:
          "إذا كنت تستخدم pnpm ui:dev، فأعد بناء أو تشغيل واجهة التطوير مقابل checkout الحالي.",
        stepRestart: "أعد تشغيل Gateway بعد تحديث Zuvix حتى يقدم البروتوكول الحالي.",
      },
      network: {
        title: "تعذر الاتصال",
        summary:
          "لم يتمكن المتصفح من إكمال اتصال Gateway. تحقق من الهدف والنقل قبل إعادة تجربة بيانات الاعتماد.",
        stepGateway: "تأكد من أن Gateway يعمل باستخدام zuvix status أو zuvix gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام zuvix dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  chat: {
