...
export const en: TranslationMap = {
  ...
  subtitles: {
    agentWorld: "Visual agent overview and status.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from zuvix dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with zuvix models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run zuvix devices list on the Gateway host.",
        stepApproveId: "Approve this request: zuvix devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with zuvix status or zuvix gateway run.",
        stepUrl:
