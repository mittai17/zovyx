...
const workspaceSourceAliases = [
  ...
  {
    find: "zuvix/plugin-sdk/test-fixtures",
    replacement: path.resolve(repoRoot, "src/plugin-sdk/test-fixtures.ts"),
  },
  {
    find: /^@zuvix\/model-catalog-core\/(.+)$/u,
  ...
  {
    find: /^@zuvix\/normalization-core\/(.+)$/u,
