...
`precise.yml` is Zuvix's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Zuvix paths are excluded by `.gitignore` for build reasons even though
