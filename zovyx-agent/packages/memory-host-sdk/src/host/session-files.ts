...
import { createSubsystemLogger, redactSensitiveText } from "./zuvix-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "zuvix:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Zuvix-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/zuvix/zuvix/issues/63921
 */
