...
const debugEmbeddings = isTruthyEnvValue(process.env.ZUVIX_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when ZUVIX_DEBUG_MEMORY_EMBEDDINGS is enabled. */
