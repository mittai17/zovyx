...
/** Minimal transport interface consumed by the Zuvix SDK client. */
export type ZuvixTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableZuvixTransport = ZuvixTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "zuvix" | "codex" | (string & {}) }
  | { type: "cli"; id: "claude-cli" | (string & {}) }
  | { type: "acp"; harness: "claude" | "cursor" | "gemini" | "zuvix" | (string & {}) }
...
export type ZuvixEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: ZuvixEventType;
