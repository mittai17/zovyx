// Zuvix SDK module implements transport behavior.
import { GatewayClient } from "@zuvix/gateway-client";
...
/** Connectable SDK transport backed by @zuvix/gateway-client. */
export class GatewayClientTransport implements ConnectableZuvixTransport {
...
): transport is ConnectableZuvixTransport {
