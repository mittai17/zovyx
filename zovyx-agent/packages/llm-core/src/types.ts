...
/** Provider API families with first-class request/stream adapters in Zuvix. */
...
/** Image-generation API families with first-class adapters in Zuvix. */
...
/** Image provider ids with first-class adapters in Zuvix. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Zuvix thinking levels to provider/model-specific values.
