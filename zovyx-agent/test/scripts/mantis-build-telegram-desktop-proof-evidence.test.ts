...
describe("scripts/mantis/build-telegram-desktop-proof-evidence", () => {
  it("builds paired native Telegram Desktop GIF evidence for PR comments", () => {
    ...
    const artifactUrl = "https://github.com/zuvix/zuvix/actions/runs/1/artifacts/2";
    const body = renderEvidenceComment({
      artifactUrl,
      manifest,
      marker: "<!-- mantis-telegram-desktop-proof -->",
      rawBase: "https://qa.zuvix.ai/mantis/telegram-desktop/pr-1/run-1",
      requestSource: "workflow_dispatch",
      runUrl: "https://github.com/zuvix/zuvix/actions/runs/1",
      treeUrl: "https://qa.zuvix.ai/mantis/telegram-desktop/pr-1/run-1/index.json",
    });
    ...
    expect(body).toContain(
      '<img src="https://qa.zuvix.ai/mantis/telegram-desktop/pr-1/run-1/baseline/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      '<img src="https://qa.zuvix.ai/mantis/telegram-desktop/pr-1/run-1/candidate/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      "Raw QA files: https://qa.zuvix.ai/mantis/telegram-desktop/pr-1/run-1/index.json",
    );
