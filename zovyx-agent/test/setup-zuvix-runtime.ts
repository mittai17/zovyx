// Zuvix runtime test setup installs runtime mocks and cleanup.
...
const WORKER_RUNTIME_STATE = Symbol.for("zuvix.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("zuvix.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("zuvix.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: ZuvixConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
