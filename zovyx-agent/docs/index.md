---
summary: "Zuvix is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Zuvix to newcomers
title: "Zuvix"
---
...
<p align="center">
    <img
        src="/assets/zuvix-logo-text-dark.png"
        alt="Zuvix"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/zuvix-logo-text.png"
        alt="Zuvix"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Zuvix and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `zuvix onboard` and pairing flows.
  </Card>
...
Zuvix is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-zuvix.jpg" alt="Zuvix" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.zuvix/zuvix.json`.

- If you **do nothing**, Zuvix uses the bundled Zuvix agent runtime with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@zuvix"] } },
}
```
