...
Zuvix formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** - see [docs](https://docs.zuvix.ai).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.zuvix.ai" }]
}
```
