...
Linux desktop, VNC rescue, Slack Web, a real Zuvix gateway, screenshots,
...
- Mantis artifacts: owned by the Zuvix run. They live under
...
- remote logs such as `slack-desktop-command.log`, `zuvix-gateway.log`,
...
- `crabbox.remote_run`: sync, browser launch, Zuvix install/build or
...
remote status after Mantis has copied metadata proving that either the Zuvix
