---
summary: "CLI reference for `zuvix voicecall` (voice-call plugin command surface)"
read_when:
...
zuvix voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
zuvix voicecall call     -m <text> [-t <phone>] [--mode <m>]
zuvix voicecall start    --to <phone> [--message <text>] [--mode <m>]
zuvix voicecall continue --call-id <id> --message <text>
zuvix voicecall speak    --call-id <id> --message <text>
zuvix voicecall dtmf     --call-id <id> --digits <digits>
zuvix voicecall end      --call-id <id>
zuvix voicecall status   [--call-id <id>] [--json]
zuvix voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
zuvix voicecall latency  [--file <path>] [--last <n>]
zuvix voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Zuvix voice call smoke test.` | Message to speak during the smoke call. |
...
zuvix voicecall smoke --to "+15555550123"        # dry run
zuvix voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
zuvix voicecall call --to "+15555550123" --message "Hello"
zuvix voicecall call -m "Heads up" --mode notify
```
...
```bash
zuvix voicecall status
zuvix voicecall status --json
...
```bash
zuvix voicecall expose --mode serve
zuvix voicecall expose --mode funnel
zuvix voicecall expose --mode off
```
