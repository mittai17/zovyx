---
summary: "CLI reference for `zuvix system` (system events, heartbeat, presence)"
read_when:
...
zuvix system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$ZUVIX_GATEWAY_TOKEN"
zuvix system heartbeat enable
zuvix system heartbeat last
zuvix system presence
```
