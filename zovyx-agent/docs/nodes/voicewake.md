...
Zuvix treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.zuvix/settings/voicewake.json`

Shape:

```json
{ "triggers": ["zuvix", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
