---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to Zuvix."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to Zuvix.

## Distribution

- Package: `@zuvix/google-plugin`
