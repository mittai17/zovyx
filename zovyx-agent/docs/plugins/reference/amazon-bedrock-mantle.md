---
summary: "Zuvix Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
Zuvix Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.

## Distribution

- Package: `@zuvix/amazon-bedrock-mantle-provider`
