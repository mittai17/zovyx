---
summary: "Zuvix Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Zuvix Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@zuvix/anthropic-vertex-provider`
