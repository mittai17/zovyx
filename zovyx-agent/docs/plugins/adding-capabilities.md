---
summary: "Contributor guide for adding a new shared capability to the Zuvix plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Zuvix core developers. If you are
...
Use this when Zuvix needs a new shared domain such as embeddings, image
