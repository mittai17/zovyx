---
summary: "Testing utilities and patterns for Zuvix plugins"
...
Reference for test utilities, patterns, and lint enforcement for Zuvix
plugins.
...
These test-helper subpaths are repo-local source entrypoints for Zuvix's own
...
**Plugin API mock import:** `zuvix/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `zuvix/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `zuvix/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `zuvix/plugin-sdk/channel-test-helpers`

**Channel target test import:** `zuvix/plugin-sdk/channel-target-testing`

**Plugin contract import:** `zuvix/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `zuvix/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `zuvix/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `zuvix/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `zuvix/plugin-sdk/test-env`

**Generic fixture import:** `zuvix/plugin-sdk/test-fixtures`

**Node builtin mock import:** `zuvix/plugin-sdk/test-node-mocks`

Inside the Zuvix repo, prefer the focused subpaths below for new bundled
plugin tests. The broad
`zuvix/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "zuvix/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "zuvix/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "zuvix/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "zuvix/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "zuvix/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "zuvix/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "zuvix/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "zuvix/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "zuvix/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "zuvix/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "zuvix/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "zuvix/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "zuvix/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Zuvix inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "zuvix/plugin-sdk/plugin-test-runtime";
```
...
Zuvix's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `zuvix/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `zuvix/plugin-sdk` root barrel is rejected
...
Zuvix uses Vitest with V8 coverage thresholds. For plugin tests:
