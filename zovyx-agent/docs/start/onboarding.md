---
summary: "First-run setup flow for Zuvix (macOS app)"
read_when:
...
- By default, Zuvix is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Zuvix">
...
<Step title="CLI">
  ...
  The app can install the global `zuvix` CLI via npm, pnpm, or bun.
