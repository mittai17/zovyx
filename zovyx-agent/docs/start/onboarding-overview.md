---
summary: "Overview of Zuvix onboarding options and flows"
read_when:
...
Zuvix has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `zuvix onboard`                     | Launch the app            |
...
CLI command docs: [`zuvix onboard`](/cli/onboard)

## macOS app onboarding

Open the Zuvix app. The first-run wizard walks you through the same steps
