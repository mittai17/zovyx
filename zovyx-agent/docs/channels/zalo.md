...
Zalo ships as a bundled plugin in current Zuvix releases, so normal packaged
...
- Install via CLI: `zuvix plugins install @zuvix/zalo`
- Pinned version: `zuvix plugins install @zuvix/zalo@2026.5.2`
- Or from a source checkout: `zuvix plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Zuvix behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `zuvix pairing list zalo`
  - `zuvix pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Zuvix.
...
- Example: `zuvix message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `zuvix channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `zuvix logs --follow`
