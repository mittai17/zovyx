...
read_when:
  - Planning a broad Zuvix application modernization pass
...
modernization task. If adopting this guidance as a repo-local Zuvix skill,
create `.agents/skills/zuvix-frontend/SKILL.md` first, keep the frontmatter
