...
title: "Together AI"
read_when:
  - You want to use Together AI with Zuvix
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    zuvix onboard --auth-choice together-api-key
    ```
  </Step>
...
Zuvix ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.zuvix/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `zuvix models list --provider together`
