...
title: "Arcee AI"
read_when:
  - You want to use Arcee AI with Zuvix
...
<Tabs>
  <Tab title="Direct (Arcee platform)">
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        zuvix onboard --auth-choice arceeai-api-key
        ```
      </Step>
  ...
  <Tab title="Via OpenRouter">
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        zuvix onboard --auth-choice arceeai-openrouter
        ```
      </Step>
      <Step title="Set a default model">
        ```json5
...
Zuvix currently ships this bundled Arcee catalog:
...
<AccordionGroup>
  ...
  <Accordion title="OpenRouter routing">
    ...
    Zuvix handles routing transparently based on your auth choice. See the
