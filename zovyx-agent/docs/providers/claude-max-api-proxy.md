...
<Steps>
  ...
  <Step title="Configure Zuvix">
    Point Zuvix at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Zuvix
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Zuvix integration with Claude CLI or API keys.
  </Card>
