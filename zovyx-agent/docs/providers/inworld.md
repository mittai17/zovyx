---
summary: "Inworld streaming text-to-speech for Zuvix replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Zuvix it
...
Zuvix posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Zuvix synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Zuvix asks Inworld for `OGG_OPUS` so the audio plays as a native
